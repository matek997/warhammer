...
export const arrCareers = [
  [
    ...
    "Academic Knowledge (any two);Academic Knowledge (Theology);Animal Care;Arcane Language (Magick);Charm;Common Knowledge (any two);Gossip;Heal;Perception;Read/Write;Speak Language (any two);Speak Language (Classical)",
    "Master Orator;Savvy;Strong-Minded",
    "Prayer Book;Religious Relic;Robes;Writing Kit",
    "Anointed Priest;High Priest;Monk;Scholar",
    "High Priest;Scholar",
    "",
    "TOS",
    12,
  ...
  [
    ...
    0,
    0,
    "Commanding a fleet of ships, Admirals are the true lords of the sea. While most are employed by one of the navies of the Old World, some Admirals are pirates commanding a flotilla of bloodthirsty marauders. Many Sea Captains envy their position, so Admirals must be quick-witted and charismatic to see off attacks; after all, once at sea, almost anything can happen, and only the survivors can tell the tale. Because of this, many Admirals are paranoid individuals who are jealous of their power, and most are quick to end any imagined mutiny with their loyal Marines or Pirates.",
    "Academic Knowledge (any one);Academic Knowledge (Strategy/Tactics);Charm or Dodge Blow;Command;Common Knowledge (any three);Intimidate;Perception;Read/Write;Sail;Speak Language (any three);Swim",
    ...
    "Noble Lord;Sea Captain",
    "Ambassador;Explorer;Guild Master",
    "",
    "SoE",
    11,
    4,
  ...
  [
    ...
    "Academic Knowledge (Necromancy, Theology, plus any one);Charm;Common Knowledge (The Empire, Tilea);Concealment;Disguise;Follow Trail;Gossip;Heal;Intimidate;Perception;Read/Write;Search;Silent Move;Shadowing;Speak Language (any two)",
    ...
    "Barber-Surgeon;Fieldwarden;Initiate (Morr);Scholar;Student;Tomb Robber;Vampire Hunter",
    "Killer of the Dead;Priest (Morr only);Scholar;Spy;Vampire Hunter;Witch Hunter",
    "",
    "NDM",
    15,
    4,
  ...
  [
    ...
    0,
    0,
    "For the most part, the people of the Empire have little say in politics. ...",
    "Academic Knowledge (History) or Gossip;Academic Knowledge (Law) or Common Knowledge (the Empire);Concealment;Charm;Perception;Read/Write;Speak Language (Breton or Tilean);Speak Language (Reikspiel)",
    "Coolheaded or Street Fighting;Flee!;Public Speaking",
    "Light Armour (Leather Jack);One set of Good Craftsmenship Clothes;2d10 leaflets for various causes",
    "Burgher;Captain;Herald;Highwayman;Scribe;Servant;Student;Zealot",
  ...
  [
    ...
    0,
    0,
    "Granted the right to speak on behalf of their sovereign, ambassadors can wield much power in the various national and provincial capitals of the Old World. In Kislev, ambassadors work tirelessly from their well-guarded embassies, keen to do whatever is necessary to catch the Ice Queen’s eye. While some ambassadors are chosen for their exquisite tastes and ability to spoil rivals and allies alike with carefully chosen words and gifts, others may be selected for their sharp minds, understanding of intelligence networks, or undeniable charisma. Whatever their individual strengths, all ambassadors are of noble birth, for the Tzarina would never deign to meet a foreign peasant.",
    "Academic Knowledge (Genealogy/Heraldry or History);Blather or Charm;Command;Common Knowledge (any two);Gossip;Haggle;Perception;Performer (Actor);Read/Write;Ride;Speak Language (any three)",
    "Dealmaker or Schemer;Etiquette;Linguistics or Suave;Master Orator or Savvy;Public Speaking",
    "several sets of superior noble’s garb;valuable jewellery;a contingent of guards (no fewer than six);coin, jewellery, art objects, property, and so on worth no less than 1,000 gc",
    "Captain;High Priest;Ice Witch;Noble Lord;Wizard Lord",
    "Captain;Merchant;Noble Lord;Politician",
    "You must be of noble birth (i.e. complete the Noble Career) and be appointed by a government.",
    "RotIQ",
    11,
    5,
    35,
  ...
  [
    ...
    0,
    0,
    "Some people feel that they can only follow their own mystical leanings alone, away from the distractions of civilisation, conversation, and soap. These individuals become Anchorites, staking claim to a cave, or the top of a pillar of rock, somewhere in the Borderlands. They have few or no possessions, so bandits rarely bother them. Greenskins and other monsters are still likely to kill them if they can catch them, so Anchorites learn how to hide and run away.",
    "Concealment;Outdoor Survival;Perception;Scale Sheer Surface;Silent Move",
    "Flee!;Hardy;Resistance to Poison;Rover;Stout-hearted",
    "None",
    "None",
    "Badlander;Mystic;Outlaw;Swamp Skimmer;Vagabond",
    "",
    "RC",
    5,
    5,
  ...
  [
    ...
    "Animal Care;Animal Training;Charm Animal;Command;Common Knowledge (any one);Drive or Swim;Perception;Ride;Speak Language (any one);Trade (any two: Aviarist;Horse trader;Kennel master or Stableman)",
    ...
    "Bear Tamer;Entertainer;Farmer;Hunter;Muleskinner;Peasant;Rat Catcher",
    "Bear Tamer;Entertainer;Hunter",
    "",
    "CC",
    12,
    3,
  ...
  [
    ...
    "Academic Knowledge (Science);Gossip;Haggle;Heal or Prepare Poison;Perception;Read/Write;Secret Language (Guild Tongue);Speak Language (Classical);Trade (Apothecary)",
    "Etiquette or Resistance to Poison;Suave or Very Resilient",
    "  Healing Draught;Light Armour (Leather Jerkin);Trade Tools (Apothecary’s Kit)",
    "Apprentice Wizard;Barber-Surgeon;Hedge Wizard;Student",
    "Apprentice Wizard;Artisan;Barber-Surgeon;Embalmer;Grave Robber;Merchant;Physician;Scholar",
    "",
    "SH",
    9,
    2,
  ...
  [
    ...
    "Academic Knowledge (Magic) or Intimidate;Channelling;Common Knowledge (Kislev);Magical Sense;Navigation or Perception;Outdoor Survival;Speak Arcane Language (Magick);Speak Language (Kislevarin)",
    "Aethyric Attunement or Lesser Magic (any one);Hardy or Very Resilient;Petty Magic (Ice)",
    "sturdy suit of winter clothing;a pack or sling bag;a flask of kvas;few days of rations.",
    "Any",
    "Ice Maiden;Initiate (of Ulric);Witch",
    "You must be female to enter this career.",
    "RotIQ",
    8,
    3,
    10,
  ...
  [
    ...
    0,
    0,
    "Humans born with magical talents are dangerous and feared individuals.",
    "Academic Knowledge (Magic);Channelling;Magical Sense;Perception;Read/Write;Search;Speak Arcane Languages (Magick);Speak Language (Classical)",
    "Aethyric Attunement or Fast Hands;Petty Magic (Arcane);Savvy or Very Resilient",
    "Quarter Staff;Backpack;Printed Book",
    "Hedge Wizard, Scholar, Scribe, Student",
    "Journeyman Wizard, Scholar, Scribe",
    "If you want to be able to cast spells right away, you should increase your Magic Characteristic with your free advance during character creation.",
    "WHFR",
    8,
    3,
    10,
  ...
  [
    ...
    "Academic Knowledge (Engineering);Academic Knowledge (Science);Command;Drive;Perception;Secret Language (Battle Tongue);Trade (Gunsmith)",
    ...
    "Engineer;Sergeant",
    "Artisan;Captain;Guild Master;Mercenary;Veteran",
    "",
    "WC",
    7,
    7,
  ...
  [
    ...
    "Net;4 Throwing Knives;Grappling Hook;10 yards of Rope;1 dose on Poison (any)",
    "Champion;Duellist;Judicial Champion;Outlaw Chief;Spy;Targeteer",
    "Champion;Outlaw Chief;Rogue;Sergeant;Witch Hunter",
    "",
    "WHFR",
    9,
    9,
  ...
  [
    ...
    "Academic Knowledge (History or Law, Strategy Tactics or Theology);Charm or Intimidate;Command;Common Knowledge (Kislev or Troll Country);Gossip or Outdoor Survival;Haggle;Perception;Ride;Speak Language (Kislevarin)",
    "Coolheaded or Suave;Public Speaking",
    "Ceremonial mace (Superior Hand Weapon) recognised as a symbol of authority throughout Kislev.",
    "Captain;Horse Master;Noble;Veteran",
    "Politician;Priest;Noble Lord",
    "",
    "RotIQ",
    9,
    2,
  ...
  [
    ...
    "Concealment;Follow Trail;Outdoor Survival;Navigation;Perception;Scale Sheer Surface;Search;Silent Move",
    "Orientation;Sixth Sense",
    "Climbing Equipment",
    "Anchorite;Peasant;Vagabond",
    "Cat Burglar;Vagabond",
    "",
    "RC",
    8,
    2,
  ...
  [
    ...
    0,
    0,
    "The Badlands Ranger is an experienced individual familiar with the hazards of the area and able to lead others safely through them. A trustworthy Badlands Ranger is worth a great deal of money, and they charge a great deal of money to those who want their services. Threatening them rarely works because they can survive almost any situation in the region. They will simply leave their obnoxious employers to die.",
    "Common Knowledge (Border Princes);Concealment;Dodge Blow;Follow Trail;Navigation;Outdoor Survival;Perception;Scale Sheer Surface;Secret Language (Ranger Tongue);Secret Signs (Scout);Set Trap;Silent Move;Swim",
    "Flee!;Orientation;Rover;Sixth Sense;Very Resilient",
    "Medium Armour (Mail Shirt and Leather Jack);10 yards of Rope",
    "Explorer;Outlaw Chief;Scout",
    "Captain;Explorer;Outlaw Chief",
    "",
    "RC",
    13,
    5,
  ...
  [
    ...
    0,
    0,
    "Bailiffs are manorial officials in the service of Noble Lord.",
    "Academic Knowledge (Law);Animal Care or Gossip;Charm;Command or Navigation;Intimidate or Common Knowledge (the Empire);Perception;Read/Write;Ride",
    "Etiquette or Super Numerate;Public Speaking",
    "Light Armour (Leather Jack and Leather Skullcap);Riding Horse with Saddle and Harness;One Set of Good Craftmanship Clothing",
    "Bodyguard, Jalier",
    "Militiaman, Politician, Protagonist, Racketeer, Smuggler, Toll Keeper",
    "",
    "WHFR",
    8,
    2,
  ...
  [
    ...
    "Charm;Drive or Swim;Haggle;Heal;Perception;Read/Write;Speak Language (Breton, Reikspiel, or Tilean);Trade (Apothecary)",
    "Resistance to Disease or Savvy;Suave or Very Resilient;Surgery",
    "Trade Tools (Barber-Surgeon)",
    "Initiate, Student",
    "Interrogator, Grave Robber, Physician, Tradesman, Vagabond",
    "",
    "WHFR",
    8,
    3,
  ...
  [
    ...
    "Charm;Command;Common Knowledge (Bretonnia);Dodge Blow;Haggle;Intimidate;Outdoor Survival;Perception",
    "Flee!;Hardy;Public Speaking;Stout-hearted;Strike to Stun;Strong-minded;Very Resilient;Very Strong",
    "Halberd;Bow and 20 Arrows;Medium Armour (Full Mail Armour)",
    "Grail Pilgrim",
    "Faceless;Sergeant;Vagabond;Veteran",
    "Women may only become Battle Pilgrims if they are disguised as men, nobles only if they are disguised as peasants.",
    "KotG",
    8,
    8,
    26,
  ...
  [
    ...
    "Animal Care;Animal Training;Charm Animal;Consume Alcohol or Gossip;Perception or Performer (any one);Speak Language (Kislevarin)",
    "Coolheaded or Very Strong;Lightning Reflexes or Public Speaking;Very Resilient or Wrestling",
    "leather jacks;a collar and chain;a whip or goad;a bear",
    "Entertainer;Initiate of Ursun;Priest of Ursun",
    "Animal Trainer;Entertainer;Initiate of Ursun;Pit Fighter;Soldier",
    "",
    "RotIQ",
    6,
    3,
  ...
  [
    ...
    "Academic Knowledge (Necromancy, Theology);Dodge Blow;Intimidate;Perception;Ride;Secret Language (Battle Tongue);Speak Language (any two)",
    ...
    "Knight;Priest (Morr only);Sergeant;Squire;Vampire Hunter;Witch Hunter",
    "Captain;Champion;Priest (Morr only);Knight of the Inner Circle;Knight of the Raven;Vampire Hunter",
    "",
    "NDM",
    7,
    5,
  ...
  [
    ...
    0,
    0,
    "The rivers of the Empire are vital arteries of communication and commerce. They provide speedy transportation and link most of the major cities of the realm. ...",
    "Common Knowledge (The Empire or Kislev);Consume Alcohol or Gossip;Navigation;Outdoor Survival;Perception;Row;Sail;Secret Language (Ranger) or Speak Language (Kislevian);Swim",
    "Orientation;Seasoned Traveller",
    "Light Armour (Leather Jack);Row Boat",
    "Ferryman;Smuggler",
  ...
  [
    ...
    "Estalian Diestro;Jailer;Mercenary;Thug",
    "Bailiff;Bounty Hunter;Interrogator;Jailer;Mercenary;Protagonist;Racketeer",
    "",
    "WHFR",
    4,
    6,
  ...
  [
    ...
    "Berserker;Mercenary;Pit Fighter",
    "Berserker;Bodyguard;Freeholder;Marauder;Mercenary;Reaver;Skald;Veteran;Warleader",
    "",
    "ToC",
    4,
    5,
  ...
  [
    ...
    0,
    0,
    "Life in the courts of the Border Princes tends to be a bit more literal than in more civilised lands. Smearing an opponent involves physical mud, backstabbing involves a knife, and the losers in political contests really are gutted. Courtiers in the area thus tend to be a bit more physical than those in other regions.",
    "Charm;Command;Common Knowledge (Border Princes);Concealment;Dodge Blow;Gossip;Intimidate;Perception;Prepare Poison;Search;Speak Language (Any)",
    ...
    "Captain;Courtier;Noble;Outlaw Chief;Politician;Sergeant",
    "Assassin;Captain;Courtier;Noble Lord;Spy",
    "",
    "RC",
    11,
    6,
  ...
  [
    ...
    "Bodyguard;Fieldwarden;Hunter;Kislevite Kossar;Mercenary;Pit Fighter",
    "Mercenary;Protagonist;Scout;Targeteer;Vampire Hunter",
    "",
    "WHFR",
    7,
    4,
  ...
  [
    ...
    "Common Knowledge (the Empire) or Consume Alcohol;Drive;Evaluate;Gossip or Read/Write;Haggle;Perception;Search;Speak Language (Breton, Kislevian or Tilean);Speak Language (Reikspiel)",
    "Dealmaker;Savvy or Suave",
    "Abacus;Lantern;One Set of Good Clothing",
    "Innkeeper;Servant",
  ...
  [
    ...
    "Academic Knowledge (Strategy/Tactics);Command;Common Knowledge (Bretonnia, the Empire, or Tilea);Perception;Read/Write;Ride;Secret Language (Battle Tongue);Speak Language (Classical);Speak Language (Breton, Reikspiel, or Tilean)",
    "Disarm;Savvy or Warrior Born;Specialist Weapon Group (Fencing)",
    "Foil or Rapier;Light Armour (Full Leather Armour);Shield; Uniform (Cadet)",
    "Estalian Diestro;Mercenary;Militiaman;Noble;Roadwarden;Soldier;Squire;Student",
    "Herald;Mercenary;Pistolier;Sergeant;Squire;Student",
    "If you are rolling randomly for your Starting Career, you can substitute Cadet for Soldier or Student with your GM’s permission.",
    "SoE",
    9,
    3,
    10,
  ...
  [
    ...
    "Animal Care or Drive;Charm or Evaluate;Gossip;Haggle;Perception;Search;Any one of: Trade (Armourer, Bowyer, Cartographer, Cook, Gunsmith, Herbalist, Merchant, Smith, Tailor, or Weaponsmith);Speak Language (Breton, Kislevian, or Tilean);Slight of Hand",
    "Dealmaker or Street Fighter;Flee!;Hardy or Suave;Resistance to Disease or Seasoned Traveller",
    "Lucky Charm or Trade Tools;Pouch;Tent",
    "Bone Picker;Servant",
    "Charcoal-Burner;Charlatan;Servant;Smuggler;Spy;Tradesman;Vagabond",
    "",
    "WHFR",
    9,
    4,
  ...
  [
    ...
    "Explorer;Ghost Strider;Knight;Knight of the Inner Circle;Noble Lord;Outlaw Chief;Sergent;Witch Hunter",
    "Agitator;Explorer;Merchant;Outlaw Chief;Politician",
    "",
    "WHFR",
    10,
    4,
  ...
  [
    ...
    "Grail Pilgrim;Hunter;Outlaw;Outrider;Peasant;Woodsman;Vagabond",
    "Grail Pilgrim;Herrimault;Outlaw;Scout;Vagabond;Veteran",
    "",
    "KotG",
    8,
    4,
  ...
  [
    ...
    "Academic Knowledge (geography);Navigation;Outdoor Survival or Ride;Perception;Read/Write;Speak Language (any 2);Trade (cartography)",
    "Excellent Vision;Orientation;Seasoned Traveller or Super Numerate",
    "Writing Kit;Pony with saddle & harness;1d10 map cases",
    "Coachman;Messenger;Navigator;Scout;Scribe;Student;Tradesman",
    "Artisan;Explorer;Forger;Navigator;Scholar;Scribe;Vagabond",
    "",
    "CC",
    7,
    3,
  ...
  [
    ...
    "Concealment;Evaluate;Gossip;Haggle;Perception;Pcik Lock;Scale Sheer Surface;Search;Secret Language (Thieve's Tongue);Secret Signs (Thief);Silent Move",
    "Alley Cat;Street Fighting;Streetwise;Trapfinder",
    "Grappling Hook;Lock Picks;10 Yards of Rope",
    "Bone Picker;Charlatan;Graverobber;Rat Catcher;Thief",
    "Crime Lord;Fence;Master Thief;Racketeer;Vagabond",
    "",
    "WHFR",
    11,
    4,
  ...
  [
    ...
    0,
    0,
    "Cenobites live in communities, generally called monasteries, and follow the advice of a leader. The leader is often charismatic but often equally insane. At the very least, they are fanatical followers of a very personal vision of the truth (the con-artists do not set up in the Borderlands). Most Cenobites are Human; members of other races rarely show much interest, though most monasteries would admit them if they asked. Unwanted children are sometimes left on the doorsteps of monasteries. These children are taken in; those who do not run away are accepted as Cenobites. Most run away.",
    "Academic Knowledge (Theology);Blather;Common Knowledge (Border Princes);Heal;Perception;Torture",
    "Hardy;Resistance to Poison;Stout-hearted;Strong-minded",
    "Filthy Loincloth and Tunic",
    "None",
    "Mystic;Outlaw;Servant;Vagabond",
    "It is possible for those who seek to purify mind and body to volunteer to become cenobites, even though most are raised in the role. With GM approval, the cenobite career may be entered from apprentice wizard, initiate, grave robber, or zealot.",
    "RC",
    6,
    4,
    10,
  ...
  [
    ...
    0,
    0,
    "Champions are warriors who dedicate their lives to martial combat, excelling as no others on the field of battle. They are not leaders of men, bu as individual combatants they are peerless. They live for the moment when their skills are tested to the utmost, for only then do they truly know just how good they are.",
    "Dodge Blow;Evaluate;Initimidate;Perception",
    "Fleet Footed or Lightning Reflexes;Lightning Parry;Master Gunner;Might Shot;Quick Draw;Rapid Reload;Specialist Weapon Group (any three);Wrestling",
    "Any Six Weapon (all of Best Craftmanship);Medium Armour (Mail Shirt and Leather Jack)",
    "Assassin, Duellist, Judicial Champion, Knight of the Inner Circle, Targeteer, Veteran, Witch Hunter",
    "Assassin, Scout, Sergeant, Witch Hunter",
    "",
    "WHFR",
    4,
    8,
  ...
  [
    ...
    "Common Knowledge (the Empire) or Concealment;Drive or Gossip;Haggle;Outdoor Survival;Perception;Scale Sheer Surface;Search;Secret Signs (Ranger)",
    "Flee!;Savvy or Very Strong",
    "3 Torches;Tinderbox;Hand Weapon (Hatchet)",
    "Camp Follower;Hunter;Miner;Peasant",
  ...
  [
    ...
    "Blather;Charm;Common Knowledge (Bretonniaor Tilea);Disguise;Evaluate;Gamble;Gossip;Haggle;Perception;Secret Language (Thieves Tongue);Sleight of Hand;Speak Language (Breton or Tilean);Speak Language (Reikspiel)",
    "Flee!;Mimic;Public Speaking;Schemer or Streetwise;Seasoned Traveller",
    "6 sets of Common Clothes;4 sets of Best Craftsmenship Clothes;Forged Documents;4 bottles of various coloured water;4 bottles of variously coloured powder",
    "Agitator;Camp Follower;Courtier;Entertainer;Envoy;Fence;Hedge Wizard;Journeyman Wizard;Minstrel;Rogue;Smuggler;Thief",
    "Astrologer;Cat Burglar;Demagogue;Outlaw;Politician;Spy",
    "",
    "WHFR",
    13,
    5,
  ...
  [
    ...
    "Academic Knowledge (Law or Intimidate);Command;Common Knowledge (Kislev);Dodge Blow or Shadowing;Follow Trail;Perception;Ride;Search",
    "Disarm or Specialist Weapon Group (Gunpowder);Menacing;Strike Mighty Blow or Strike to Stun",
    "leather jacks and leggings;helmet;Hand Weapon;Kislevite horse;saddle;harness;and saddlebags",
    "Kossar;Protagonist;Streltsi;Thug;Watchman",
    "Jailer;Interrogator;Mercenary;Racketeer;Sergeant;Soldier;Spy;Veteran;Watchman",
    "",
    "RotIQ",
    8,
    3,
  ...
  [
    ...
    "Common Knowledge (the Empire);Consume Alcohol;Gossip;Haggle;Perception;Scale Sheer Surface;Search;Silent Move",
    "Contortionist or Very Strong;Streetwise",
    "Brush;Grappling Hook;10 Yards of Rope",
    "Charcoal Burner;Miner;Peasant;Rogue;Thief",
    "Cat Burglar;Mercenary;Militiaman;Protagonist;Rat Catcher",
    "",
    "FoN",
    8,
    2,
  ...
  [
    ...
    "Charm;Common Knowledge (any three);Concealment;Disguise;Gossip;Perception;Read/Write;Search;Secret Language (any two);Secret Signs (any two);Silent Move;Speak Language (any four);Trade (any one)",
    "Acute Hearing;Alley Cat;Coolheaded;Linguistics or Mimic;Savvy or Suave;Schemer;Streetwise",
    "Light Armour (Leather Jack);Hand Weapon;Garrotte;Cloak;Good Craftsmanship Disguise Kit;three sets of Good Clothing;one Dose of Poison",
    "Assassin;Courtier;Crime Lord;Demagogue;Friar;Master Thief;Politician;Scout;Spy;Veteran;Witch Hunter",
    "Assassin;Charlatan;Crime Lord;Demagogue;Master Thief;Politician;Scout;Spy;Veteran;Witch Hunter",
    "See Old World Armoury page 31 for details on Garotte.",
    "ToC",
    13,
    7,
    40,
  ...
  [
    ...
    "Animal Care;Drive;Gossip or Haggle;Heal or Ride;Navigation;Perception;Secret Signs (Ranger);Speak Language (Breton, Kislevian, or Tilean)",
    "Quick Draw or Seasoned Traveller;Specialist Weapon Group (Gunpowder)",
    "Blunderbuss with powder/ammunition enough for 10 shots;Medium Armour (Mail Shirt and Leather Jack);Instruments (Coach Horn)",
    "Outrider;Messenger",
    "Highwayman;Outlaw;Roadwarden;Scout;Smuggler;Toll Keeper",
    "",
    "WHFR",
    8,
    2,
  ...
  [
    ...
    0,
    0,
    "Courtiers surround the nobility at court, fawning over lieges and ladies in the hopes of getting ahead. They range from sycophants who desperately wish to please, to cunning schemers who seek the keys to wealth and prestige. Courtiers are frequently well-read and skilled public speakers, as they are often called upon to offer erudite opinions on a variety of subjects to their Noble patrons. No Courtier, no matter how clever, is ever fully secure in his position, as there is always another who desperately wants it and is willing to do nearly anything to get it. Female Courtiers are usually known as ladies-in-waiting.",
    "Academic Knowledge (the Arts or History) or Gamble;Blather;Charm;Command or Performer (any one);Common Knowledge (Bretonnia or Tilea);Evaluate;Gossip;Perception;Read/Write;Ride;Speak Language (Breton or Tilean);Speak Language (Reikspiel)",
    "Dealmaker or Etiquette;Public Speaking;Savvy or Suave;Schemer or Specialist  Weapon Group (Fencing)",
    "4 Sets of Noble’s Garb;100 gc;Valet",
    "Dilettante;Noble;Herald;Pistolier;Politician",
    "Charlatan;Duellist;Noble Lord;Politician;Steward;Spy",
    "",
    "WHFR",
    12,
    4,
  ...
  [
    ...
    "Cat Burglar;Demagogue;Fence;Guild Master;Master Thief;Outlaw Chief;Politician;Steward",
    "Demagogue;Master Thief;Outlaw Chief;Politician",
    "",
    "WHFR",
    12,
    7,
  ...
  [
    ...
    0,
    0,
    "It is perhaps the greatest deed a templar can perform to go to war in the name of the Gods. In ages past, especially during the crusades against Araby, it was unusual for a knight to not go on crusade with his order. But in more recent times crusades are far less common, especially on such a scale.",
    "Academic Knowledge (History);Academic Knowledge (Strategy/Tactics);Common Knowledge (any three);Navigation;Outdoor Survival;Perception;Ride;Secret Language (Battle Tongue);Speak Language (Arabyan, Breton, Estalian, or Tilean).",
    ...
    "Knight;Noble Lord;Sergeant;Veteran",
    "Captain;Judicial Champion;Explorer;Initiate;Knight of the Inner Circle;Noble Lord;Veteran",
    "",
    "ToS",
    9,
    6,
  ...
  [
    ...
    "Academic Knowledge (Theology);Charm;Common Knowledge (any one);Gossip;Perception;Read/Write;Speak Language (any one);Speak Language (Classical)",
    "Dealmaker;Public Speaking",
    "Robes",
    "Anointed Priest;Courtier;Initiate;Messenger;Priest;Valet",
    "Politician;Priest;Squire;Steward",
    "",
    "ToS",
    8,
    2,
  ...
  [
    ...
    "Common Knowledge (any two);Consume Alcohol;Dodge Blow;Intimidate;Scale Sheer Surface",
    " Lightning Parry;Unsettling",
    "Great Weapon",
    "Giant Slayer",
    "A glorious Death",
    "Only Dwarfs can enter this career. You must have slain a Daemon of note to enter this career. ",
    "WHFR",
    5,
    2,
    40,
  ...
  [
    ...
    "Dodge Blow;Navigate;Perception;Scale Sheer Surface;Search;Silent Move",
    ...
    "Rat Catcher, Shieldbreaker, Soldier, Tomb Raider, Watchman",
    "Engineer;Explorer;Mercenary;Sergeant;Smuggler;Veteran",
    "",
    "WC",
    6,
    5,
  ...
  [
    ...
    "Agitator;Anointed Priest;Artisan;Charlatan;Crime Lord;Flagellant;Friar;Initiate;Minstrel;Outlaw;Outlaw Chief;Politician;Rogue;Vampire Hunter;Witch Hunter",
    "Crime Lord;Friar;Mercenary;Outlaw Chief;Politician",
    "",
    "WHFR",
    13,
    4,
  ...
  [
    ...
    0,
    0,
    "Dilettantes like to think of themselves as scholars, and, indeed, they may pass as scholars among most folk; they read and write, for a start. However, they often lack the discipline or passion that leads true scholars to focus on one task and become truly skilled at that, rather spreading their efforts across many. Most dilettantes are from wealthy backgrounds; the poor find that imminent starvation focuses the mind wonderfully.",
    "Knowledge (any one);Blather;Common Knowledge (any);Common Knowledge (any);Evaluate or Gossip;Navigation;Perception;Read/Write;Secret Language (any one) or Secret Signs (any one);Speak Language (any);Speak Language (any);Trade (Artist or Calligrapher or Cartographer) (See special rule, below)",
    "Etiquette",
    "3 books;craft tools;writing kit",
    "Any Career that includes Read/Write as a Skill.",
    "Apprentice Wizard;Astrologer;Barber-Surgeon;Catechist;Charlatan;Courtier;Initiate;Navigator;Raconteur;Student;Tomb Robber;Tradesman;Verenean Investigator",
  ...
  [
    ...
    "Courtier;Estalian Diestro;Highwayman;Pistolier;Protagonist;Sergeant;Targeteer",
  ...
  [
    ...
    "Animal Care;Common Knowledge (Empire);Consume Alcohol;Drive;Haggle;Perception;Search",
    "Coolheaded;Fearless or Resistance to Disease",
    "Cart;Shovel;Bag of Maggots;Dung",
    "Bone Picker;Camp Follower;Peasant;Rat Catcher;Vagabond",
    "Bone Picker;Grave Robber;Rat Catcher;Sewer Jack;Thug",
    "",
    "FoN",
    7,
    2,
  ...
  [
    ...
    "Academic Knowledge (Necromancy, Science);Evaluate;Haggle;Heal;Perception;Read/Write;Sleight of Hand;Speak Language (Classical);Trade (Apothecary)",
    "Dealmaker or Streetwise;Resistance to Disease;Surgery",
    "Abacus;Ether-Soaked Apron;Spare Hand;Trade Tools (Barber-Surgeon);Writing Kit",
    "Apothecary;Barber-Surgeon;Student;Tradesman",
    "Apprentice Wizard;Burgher;Grave Robber;Physician;Scholar",
    "",
    "NDM",
    9,
    3,
  ...
  [
    ...
    "Charm;Command;Common Knowledge (Border Princes);Concealment;Disguise;Follow Trail;Gossip;Intimidate;Perception;Search;Shadowing;Torture",
    "Menacing;Quick Draw;Schemer;Specialist Weapon Group (Entangling);Street Fighting",
    "Medium Armour (Chain Shirt and Leather Jack);Net",
    "Bounty Hunter;Hunter;Road Warden;Watchman",
    "Spy;Witch Hunter",
    "",
    "RC",
    12,
  ...
  [
    ...
    "Academic Knowledge (Engineering);Academic Knowledge (Science);Common Knowledge (Dwarfs or Tilea);Drive or Ride;Perception;Read/Write;Speak Language (Khazalid or Tilean);Trade (Gunsmith)",
    "Master Gunner;Specialist Weapon Group (Engineer or Gunpowder)",
    "Light Armour (Leather Jack);Engineer’s Kit;6 Spikes",
    "Artisan;Miner;Student;Tradesman",
    "Artisan;Explorer;Guild Master;Pistolier;Smuggler",
    "",
    "WHFR",
    8,
    2,
  ...
  [
    ...
    0,
    0,
    "From acrobats to strongmen, from knife throwers to hypnotists, from dancers to ventriloquists, the Empire is full of Entertainers. Some do it for the roar of the crowd and others for the money. Many become Entertainers just to escape the hard life of the Imperial villager. Entertainers travel frequently, sometimes alone but more often in troupes that perform in villages, towns, and cities. Lucky troupes get continuous bookings, sometimes spending months in the same city. The less fortunate scrape by as they can, always looking for a more appreciative crowd (or a less suspicious watch) over the next hill. The very best Entertainers gain Noble sponsorship and earn undreamed of sums of money performing for the upper crust.",
    "Animal Care or Swim;Charm;Common Knowledge (the Empire);Evaluate or Gossip;Perception;Performer (any two);Speak Language (Reikspiel);Any one of: Animal Training, Blather, Charm Animal, Hypnotism, Ride, Scale Sheer Surface, Sleight of Hand, Ventriloquism",
    ...
    "Light Armour (Leather Jerkin);Any one of: Instrument (any onee), Trade Tools (Performer), 3 Throwing Knives, 2 Throwing Axes;Any one of: Costume;One Set of Good Craftmanship Clothes",
    "Herald;Rogue;Thief;Vagabond",
  ...
  [
    ...
    0,
    0,
    "The elder members of the great Elven mercantile families are far removed from the everyday life of the Empire. To them, Humans live and die so quickly that it’s hard to keep up with current trends and politics in the Old World. When they need such knowledge, they turn to their Envoys. These young Elves are the public face of the Merchant Houses. They negotiate the contracts, make the deals, and keep the peace with the Humans of trading hubs such as Altdorf, Nuln, and Marienburg. Even Elves have a limit to their patience, so it is unsurprising that many Envoys take leave of their families for the adventurer’s life.",
    "Charm;Common Knowledge (the Empire or the Wasteland);Evaluate;GOssip;Haggle;Perception;Read/Write;Secret Language (Guild Tongue);Swim;Trade (Merchant)",
    "Dealmaker or Seasoned Traveller",
    "Light Armour (Leather Jack);2 sets of Good Workmanship Clothes;Writing Kit",
    "Student;Tradesman",
    "Charlatan;Merchant;Rogue;Seaman;Student;Vagabond",
    "Only Elves can enter this career.",
    "WHFR",
    10,
    1,
    10,
  ...
  [
    ...
    "Foil or Rapier;One set of Best Craftmanship Clothes;Perfume or Cologne;Healing Draught",
    "none",
    "Bodyguard;Duellist;Highwayman;Protagonist;Rogue",
    "If this is your Starting Career, you are from Estalia, but have come to the Empire to seek adventure.",
    "WHFR",
    5,
    4,
    11,
  ...
  [
    ...
    "Agitator;Grave Robber;Outlaw;Protagonist;Rogue;Smuggler;Thief;Thug;Tomb Robber",
    "Cat Burglar;Charlatan;Fence;Grave Robber;Highwayman;Outlaw;Protagonist;Racketeer;Thug;Vagabond",
    "",
    "CC",
    4,
    3,
  ...
  [
    ...
    "Academic Knowledge (Theology);Academic Knowledge (Daemonology or Necromancy);Channelling;Command;Hypnotism;Intimidate;Magical Sense;Perception;Speak Arcane Language (Magick);Speak Arcane Language (Daemonic);Speak Language (any one)",
    ...
    "Cult Robes;License;Prayer Book;Religious Symbol",
    "Anointed Priest;Priest",
    "Anointed Priest;Lay Priest;Scholar;Witch Hunter",
    "",
    "SH",
    11,
    6,
  ...
  [
    ...
    "Captain;Engineer;Herald;Master Thief;Master Wizard;Mate;Navigator;Scholar;Scout;Sea Captain;Spy;Wizard Lord",
    "Captain;Merchant;Sea Captain;Spy",
    "",
    "WHFR",
    17,
    2,
  ...
  [
    ...
    "Battle Pilgrim;Crime Lord;Demagogue;Knight of the Realm;Noble Lord;Outlaw Chief;Politician;Questing Knight;Steward;Veteran",
    "Crime Lord;Demagogue;Explorer;Highwayman;Outlaw Chief",
    "Women can only become Faceless if disguised as men",
    "KotG",
    13,
    5,
    35,
  ...
  [
    ...
    "Animal Care;Charm Animal;Drive;Evaluate;Haggle;Intimidate or Charm;Ride;Set Trap;Trade (Farmer)",
    "Dealmaker;Hardy;Specialist Weapon (Scythe or Flail)",
    "Cart pulled by a horse or ox;scythe (two-handed weapon) or threshing flail (flail);sheep dog.",
    "Innkeeper;Merchant;Peasant;Tradesman;Veteran",
    "Innkeeper;Merchant;Militiaman;Politician;Steward",
    "",
    "CC",
    9,
    3,
  ...
  [
    ...
    "Dealmaker or Streetwise;Strike to Stun;Super Numerate",
    "Trade Tools (Engraver’s Kit);Writing Kit",
    "Bone Picker;Burgher;Cat Burglar;Ex-Convict;Grave Robber;Innkeeper;Racketeer;Rapscallion;Smuggler;Steward;Thief;Tomb Robber",
    "Charlatan;Crime Lord;Master Thief;Racketeer",
    "",
    "WHFR",
    7,
    3,
  ...
  [
    ...
    "Charm;Common Knowledge (the Empire);Evaluate or Secret Language (Ranger);Gossip or Intimidate;Haggle;Perception;Row;Swim",
  ...
  [
    ...
    "Academic Knowledge (Necromancy) or Common Knowledge (the Empire);Concealment;Follow Trail;Outdoor Survival;Perception;Search;Silent Move",
    ...
    "Hunter;Militiaman;Toll Keeper",
    "Bounty Hunter; Mercenary; Scout;Vagabond;Vampire Hunter",
    "Only Halflings can enter this career.",
    "WHFR",
    7,
    3,
    10,
  ...
  [
    ...
    "Academic Knowledge (the Arts);Charm;Common Knowledge (any two);Evaluate;Haggle;Perception;Read/Write;Secret Signs (Thief);Speak Language (any one);Trade (Artist);Trade (Calligrapher);Trade (Smith)",
    "Artistic;Coolheaded or Dealmaker;Flee! or Suave",
    "Trade Tools (Forger);Writing Kit",
    "Artisan;Cartographer;Messenger;Smuggler;Student;Tradesman",
    "Artisan;Charlatan;Fence;Scribe;Tradesman;Student;Scholar",
    "The Old World Armoury includes rules for coin forgery",
    "SH",
    12,
    3,
    21,
  ...
  [
    ...
    0,
    0,
    "One of the greatest rewards a Jarl may grant to his Bondsmen and loyal Peasants is land. Upon gaining property, these men and women are accorded a special status. For those who were not warriors, they have the same status as Bondsmen. For those who were once warriors, land is usually a gift given in exchange for lengthy and valued service. Many Freeholders eventually become Jarls if selected by their King. Otherwise, they gain a piece of land and a number of Thralls to work it.",
    "Animal Care;Command;Common Knowledge (Norsca);Drive;Evaluate;Gossip;Haggle;Speak Language (any one);Trade (any one)",
    "Dealmaker;Public Speaking;Savvy;Schemer;Suave",
    "Longhouse and at least 1 Acre of Land;1d10 Thralls;Livestock",
    "Bondsman;Burgher;Fisherman;Skald;Whaler;Tradesman",
    "Artisan;Innkeeper;Marauder;Merchant;Slaver ",
    "",
    "ToC",
    9,
    5,
  ...
  [
    ...
    "Common Knowledge (any one);Evaluate;Gossip;Haggle;Perception;Search;Trade (Cook)",
    "Dealmaker;Hardy or Rover;Stout-hearted;Streetwise",
    "Entrails bucket;frog guts;snail shells;sharp knife",
    "Bone Picker;Camp Follower;Peasant",
    "Boatman;Bone Picker;Camp Follower;Swampaire;Grail Pilgrim;Herrimault;Servant;Tradesman;Vagabond;Village Elder",
    "",
    "BotD",
    7,
    4,
  ...
  [
    ...
    0,
    0,
    "Gamblers eschew the hard work of the lower and middle classes. After all, why toil for such small rewards when a month’s income can be made with one well-played hand? Gamblers use their skill at games of chance to make money from the wealthy and the slow-witted. They haunt coaching inns and game houses, ready to part the gullible from their coins. Sometimes things go wrong and gamblers lose large sums of money. In these cases, a swift escape is in order, before the creditors discover that the debts can’t be paid. Gamblers tend to be drifters by nature, always moving on to avoid old debts and sore losers.",
    "Charm;Evaluate;Gamble;Gossip or Secret Language (Thieves’ Tongue);Perception;Sleight of Hand;Read/Write or Secret Signs (Thief)",
    "Etiquette or Streetwise;Flee! or Luck",
    "Dice;Deck of Cards;Leather Jerkin",
    "Entertainer;Noble;Rogue;Mercenary;Student;Thief;Vagabond",
    "Charlatan;Demagogue;Entertainer;Highwayman;Rapscallion;Rogue",
    "",
    "SH",
    7,
    2,
  ...
  [
    ...
    "Common Knowledge (any one);Consume Alcohol;Dodge Blow;Intimidate;Perception",
    "Fearless;Resistance to Poison;Specialist Weapon Group (Flail);Strike to Injure",
    "Great Weapon",
    "Troll Slayer",
    "Daemon Slayer",
    "Only Dwarfs can enter this career. You must have slain a Giant to enter this career.",
    "WHFR",
    5,
    4,
    24,
  ...
  [
    ...
    "Academic Knowledge (Genealogy/Heraldry);Academic Knowledge (Religion);Academic Knowledge (Strategy/Tactics);Charm;Command;Common Knowledge (Bretonnia);Dodge Blow;Perception;Ride;Secret Language (Battle Tongue)",
    ...
    "Questing Knight",
    "Captain;Courtier;Explorer;Faceless;Noble Lord;Politician",
    "Only male Bretonnian nobles can become Grail Knights. The Lady of the Lake is not fooled by disguises.",
    "KotG",
    10,
    13,
    47,
  ...
  [
    ...
    "Carcassonne Shepherd;Hunter;Herrimault;Outlaw;Peasant;Tradesman;Vagabond",
    "Battle Pilgrim;Carcassonne Shepherd;Mercenary;Herrimault;Vagabond",
    "Women may only become Grail Pilgrims if they are pretending to be men, nobles may only do so if they are pretending to be peasants.",
    "KotG",
    6,
    4,
    9,
  ...
  [
    ...
    0,
    0,
    "A grandmaster is a paragon of knightly virtues and the leader of one of the knightly orders. A grandmaster is not only one of the most fearsome warriors in the Old World, but also a legendary commander and leader of men. There are very few grandmasters in the Old World, for even amongst those dedicated individuals who have the skill and strength of mind to become a Knight of the Inner Circle, few have what it takes to reach the pinnacle of knighthood. A grandmaster is always at the forefront of an army when it marches to war, leading his fellow knights, and often the entire army, into battle. He is usually amongst the most trusted of military advisors and generals, and when not engaged in warfare is often charged with planning for it. A grandmaster of a templar order is often a leading personality within a religious cult as well, commanding total loyalty from its warriors.",
    "Academic Knowledge (Genealogy/Heraldry or Religion);Academic Knowledge (Strategy/Tactics);Animal Training;Charm;Command;Common Knowledge (any three);Dodge Blow;Intimidate;Perception;Read/Write;Ride;Secret Language (Battle Tongue);Secret Signs (Templar);Speak Language (Breton, Estalian, Kislevian, or Tilean)",
    ...
    "Captain;Champion;Noble Lord;Witch Hunter",
    "",
    "ToS",
    14,
    6,
  ...
  [
    ...
    "Academic Knowledge (Theology);Common Knowledge (the Empire);Dodge Blow;Drive;Evaluate;Perception;Outdoor Survival;Search",
    "Resistance to Disease;Stout-Hearted or Very Strong",
    "Shovel;Stench;Wheelbarrow",
    "Bone Picker;Rat Catcher;Peasant",
    "Grave Robber;Initiate (Morr only);Militiaman;Temple Guardian;Vampire Hunter;Watchman",
    "",
    "NDM",
    8,
    2,
  ...
  [
    ...
    "Academic Knowledge (Daemonology or Spirits, History or Necromancy, plus any one);Animal Care;Charm Animal;Command;Common Knowledge (Kislev or Troll Country, plus any one);Heal or Prepare Poison;Intimidate;Magical Sense;Perception;Speak Arcane Language (Magick, plus any one);Speak Language (Ungol);Trade (Apothecary or Herbalist)",
    "Aethyric Attunement;Excellent Vision or Luck;Lesser Magic (any three);Rover or Sixth Sense;Witch Lore (Hag)",
    "antitoxin kit;apothecary kit;at least three healing draughts and healing poultices;three or more potions (RoS;page 192);skin of koumiss;distinctive shawl;walking stick",
    "Hag Witch",
    "None",
    "You must be an Ungol female to enter this career",
    "RotIQ",
    12,
    5,
    33,
  ...
  [
    ...
    "Academic Knowledge (History or Spirits);Command;Common Knowledge (Kislev or Troll Country);Consume Alcohol or Perception;Heal;Intimidate;Magical Sense;Prepare Poison or Trade (Apothecary or Herbalist);Speak Arcane Language (Magick);Speak Language (Ungol)",
    "Fast Hands;Hardy or Strong-minded;Lesser Magic (any three);Meditation;Petty Magic (Hag)",
    "antitoxin kit;healing draught;healing poultice;skin of koumiss;a number of small charms that include bits of bone, locks of hair, unusual stones, and so on;shawl",
    "Wise Woman",
    "Demagogue;Hag Mother;Politician;Witch",
    "You must be an Ungol female to enter this career",
    "RotIQ",
    10,
    5,
  ...
  [
    ...
    "Animal Care or Haggle;Charm or Intimidate;Channelling;Charm Animal or Trade (Apothecary);Heal or Hypnotism;Magical Sense;Perception;Search",
    "Hedge Magic;Petty Magic (Hedge)",
    "Healing Draught;Hood",
    "None",
    "Apprentice Wizard;Charlatan;Initiate;Outlaw;Seer;Vagabond;Witch",
    "If you want to be able to cast spells right away you should increase your Magic Characteristic with your free advance during character creation.  Halflings and Dwarfs may not enter this career. Hedge Wizardry is dangerous and highly illegal in the Empire. If caught, you could well be executed.  Think carefully before entering this career.",
    "WHFR",
    8,
    2,
    9,
  ...
  [
    ...
    0,
    0,
    "A hedgecraft apprentice endures a harsh existence from dawn to dusk. They perform gruelling tasks for the hedge masters who train them. Although much of what they learn is invaluable to their journeys in becoming a hedge master, the hedge apprentices are often treated little better than servants, and perform many arduous, mundane tasks for their teachers.",
    "Animal Care or Channelling;Charm Animal or Concealment;Consume Alcohol or Gossip;Haggle or Outdoor Survival;Heal;Magical Sense or Prepare Poisons;Perception;Read/Write or Speak Arcane Language (Magick);Set Trap or Silent Move;Trade (Apothecary or Herbalist)",
    "Coolheaded or Fast Hands; Petty Magic (Hedge) or Rover",
    "Antitoxin Kit;Healing Draught;Healing Poultice;Lucky Charm",
    "Apothecary;Peasant;Hedge Witch",
    "Apothecary;Apprentice Wizard;Barber-Surgeon;Charlatan;Hedge Wizard;Hedge Master;Initiate (Ranald, Taal & Rhya);Outlaw;Scribe;Zealot",
    "If you want to be able to cast spells right away you should increase your Magic Characteristic with your free advance during character creation. Halflings and Dwarfs may not enter this career. Hedge Wizardry is dangerous and highly illegal in the Empire. If caught, you could well be executed. Think carefully before entering this career.",
    "SoE",
    10,
    2,
  ...
  [
    ...
    "Animal Care or Channelling;Charm Animal or Concealment;Command;Evaluate or Navigation;Follow Trail or Consume Alcohol;Gossip or Intimidate;Haggle or Outdoor Survival;Heal;Magical Sense or Prepare Poison;Perception;Read/Write or Speak Arcane Language (Magick);Set Trap or Silent Move;Trade (Apothecary or Herbalist)",
    ...
    "Hedgecraft Apprentice",
    "Artisan;Hedgewise;Scholar;Spy;Witch",
    "",
    "SoE",
    13,
    5,
  ...
  [
    ...
    "Animal Care or Charm;Concealment;Dodge Blow;Gossip or Secret Signs (Ranger);Outdoor Survival;Perception;Scale Sheer Surface;Silent Move",
    ...
    "Agitator;Carcassonne Shepherd;Charlatan;Coachman;Grail Pilgrim;Hunter;Innkeeper;Knight Errant;Man-at-Arms;Noble;Peasant;Rogue;Woodsman",
    "Demagogue;Grail Pilgrim;Scout;Thief;Vagabond;Veteran",
    "Women can only become Herrimaults if disguised as men.",
    "KotG",
    8,
    3,
    10,
  ...
  [
    ...
    0,
    0,
    "A High Priest is the living embodiment of his God’s will in the Old World. They are fairly rare, as few individuals have both the strength of character and the boundless faith it takes to reach such a lofty post. High Priests, with very few exceptions, will operate out of one of the primary centres of their faith. Pilgrims will travel the breadth of the Empire just to speak for a few moments with such a being. High Priests tend to either reject the physical world, retiring to a monastery or embrace the temporal, becoming powerful secular leaders.",
    "Academic Knowledge (any three);Academic Knowledge (Theology);Channelling;Charm;Common Knowledge (any two);Gossip;Heal;Intimidate;Magical Sense;Ride or Swim;Speak Arcane Language (Magick);Speak Language (any three)",
    ...
    "Religious Relic",
    "Anointed Priest",
    "Exalted Cleric;Politician;Scholar;Witch Hunter",
    "",
    "WHFR",
    12,
    5,
  ...
  [
    ...
    "Coachman;Duellist;Ex-Convict;Estalian Diestro;Ferryman;Minstrel;Outlaw;Outrider;Rapscallion;Roadwarden;Toll Keeper",
    "Agitator;Duellist;Master Thief;Outlaw Chief;Sergeant",
    "",
    "WHFR",
    8,
    9,
  ...
  [
    ...
    "Concealment;Follow Trail or Set Trap;Perception;Scale Sheer Surface;Secret Language (Ranger Tongue);Secret Signs (Ranger);Silent Move",
    "Frenzy;Hardy;Fleet Footed or Very Resilient",
    "Anti-toxin kit;Great weapon (two-handed axe);Light Armour (leather jack)",
    "Initiate (of Taal);Scribe",
  ...
  [
    ...
    "Academic Knowledge (Strategy/Tactics);Command or Navigation;Common Knowledge (Kislev or Troll Country);Consume Alcohol;Dodge Blow;Outdoor Survival;Perception;Ride;Speak Language (Kislevarin or Ungol)",
    "Coolheaded or Hardy;Mighty Shot or Sure Shot;Rapid Reload or Quick Draw;Specialist Weapon Group (Cavalry)",
    "leather jacks and leggings;good luck charm;cavalry spears (as demilance);Kislevite horse bow with quivers containing 20 arrows, 20 armour-piercing arrows, and at least 5 screamer and 5 incendiary arrows;Kislevite warhorse;saddle and harnesse;saddle bags;rations;water skins;a yurta",
    "Horse Master;Noble;Peasant;Steppes Nomad",
    "Captain;Horse Master;Mercenary;Scout;Steppes Nomad;Targeteer;Veteran",
    "",
    "RotIQ",
    9,
    4,
  ...
  [
    ...
    "Animal Care;Charm or Consume Alcohol;Charm Animal;Evaluate;Gossip;Haggle;Perception;Ride;Speak Language (Kislevarin)",
    "Dealmaker or Flee!;Specialist Weapon Group (Entangling);Suave",
    "set of superior clothing;lasso or whip;1d5 horses of varying quality;1d10 gc",
    "Burgher;Drover;Horse Master;Messenger;Steppes Nomad",
    "Burgher;Charlatan;Horse Master;Merchant;Rogue",
    "",
    "RotIQ",
    9,
    3,
  ...
  [
    ...
    "Animal Care;Animal Training;Charm;Charm Animal;Consume Alcohol or Dodge Blow;Drive;Perception;Ride",
    "Coolheaded or Hardy;Specialist Weapon Group (Entangling);Very Strong",
    "Kislevite horse or warhorse;saddle;harness;saddlebag;grooming kit;feed;lasso or whip;leather jacks and leggings",
    "Drover;Horse Archer;Horse Coper;Mercenary;Noble;Outlaw;Outrider;Pistolier;Roadwarden;Scout;Soldier;Squire;Steppes Nomad;Winged Lancer",
    "Ataman;Drover;Horse Archer;Horse Coper;Merchant;Sergeant;Winged Lancer",
    "",
    "RotIQ",
    8,
    3,
  ...
  [
    ...
    0,
    0,
    "While the Empire has come far from the tribes that founded it 2500 years ago, some things haven’t changed at all. Although Peasants till parts of the land, huge expanses of the Empire are still covered with forest or are hostile to agriculture. These are the lands where Hunters and trappers thrive. They use the same techniques as their ancestors to take down game, be it a trap or a well-placed shot. It takes skill to stalk wild animals while avoiding the dark creatures of the woods. Hunters in their animal skin clothes and fur hats may appear uncouth to city folks, but they don’t much care what others think of them.",
    "Concealment;Follow Trail;Outdoor Survival;Perception;Search or Swim;Secret Signs (Ranger);Silent Move or Set Trap",
    "Hardy or Specialist Weapon Group (Longbow);Lightning Reflexes or Very Resilient;Marksman or Rover;Rapid Reload",
    "Longbow with 10 Arrows;2 Animal Traps;Antitoxin Kit",
    "Animal Trainer;Charcoal-Burner;Kithband Warrior;Woodsman",
    "Animal Trainer;Bounty Hunter;Charcoal-Burner;Fieldwarden;Kithband Warrior;Miner;Scout;Soldier;Targeteer",
    "",
    "WHFR",
    7,
    4,
  ...
  [
    ...
    "Academic Knowledge (Magic);Channelling;Command or Intimidate;Common Knowledge (Kislev);Magical Sense;Navigation or Read/Write;Outdoor Survival or Ride;Perception;Speak Arcane Language (Magick);Speak Language (Kislevarin)",
    "Coolheaded;Lesser Magic (any three);Meditation or Mighty Missile;Stout-hearted or Strong-minded;Witch Lore (Ice)",
    "sturdy winter clothing;flask of kvas",
    "Apprentice Witch",
    "Courtier;Ice Witch;Scout;Sergeant;Veteran;Witch",
    "You must be female to enter this career",
    "RotIQ",
    10,
    5,
  ...
  [
    ...
    "Academic Knowledge (Magic, plus any one);Channelling;Command or Intimidate;Common Knowledge (Kislev, plus any one);Magical Sense;Outdoor Survival or Ride;Perception;Read/Write;Speak Arcane Language (Magick);Speak Language (Kislevarin, plus any two)",
    "Fast Hands;Lesser Magic (any three);Menacing or Unsettling",
    "superior winter clothing;a few bits of jewellery studded with diamonds or sapphires;at least one magic item found during their wanderings as ice maidens",
    "Ice Maiden",
    "Ambassador;Captain",
    "You must be female to enter this career",
    "RotIQ",
  ...
  [
    ...
    "Blather or Lip Reading;Charm;Common Knowledge (the Empire);Consume Alcohol;Evaluate;Gossip;Haggle;Perception;Read/Write or Sleight of Hand;Speak Language (Breton, Kislevian, Reikspiel or Tilean);Trade (Cook)",
    "Etiquette or Streetwise;Dealmaker or Street Fighting;Strike to Stun",
    "Inn;one or more Servants",
    "Burgher;Farmer;Servant",
  ...
  [
    ...
    "5 knives;Flail;3 sets of manacles",
    "Barber-Surgeon;Bodyguard;Flagellant;Jailer;Thug",
  ...
  [
    ...
    "Command;Consume Alcohol;Dodge Blow;Heal or Sleight of Hand;Intimidate;Perception;Search",
    "Resistance to Disease;Resistance to Poison;Specialist Weapon Group (Entangling);Wrestling",
    "Bottle of Common Wine;Tankard;Any one of Bola or Lasso or Net",
    "Bodyguard;Rat Catcher",
    "Bailiff;Bodyguard;Interrogator;Rat Catcher;Watchman",
    "",
    "WHFR",
    7,
    4,
  ...
  [
    ...
    0,
    0,
    "Human Journeymen Wizards have completed their apprenticeship and joined an Order of Wizardry. They now have access to all the spells of their chosen lore, but they must balance their newfound powers with their faltering ability to control them. The majority of Journeymen owe considerable teaching fees to their College, and must adventure to repay their debt. Journeymen Wizards hire out their services, often at their Orders’ request, for gold, knowledge and political betterment of their College. Elves, of course, are exempt from the College system, and owe nothing.",
    "Academic Knowledge (Magic);Academic Knowledge (any one);Channelling;Charm or Intimidate;Common Knowledge (any two);Gossip;Magical Sense;Read/Write;Ride or Swim;Speak Arcane Language (Magick);Speak Language (any two)",
  ...
  [
    ...
    "Sergeant;Veteran",
    "Assassin;Champion;Sergeant;Witch Hunter;Zealot",
    "",
    "WHFR",
    2,
    5,
  ...
  [
    ...
    "Academic Knowledge (Necromancy);Concealment;Follow Trail;Intimidate;Outdoor Survival;Shadowing;Silent Move;Torture",
    ...
    "Blessed Water;6 Stakes;Silvered Weapon",
    "Agent of the Shroud;Black Guard;Flagellant;Knight of the Raven;Vampire Hunter;Witch Hunter",
    "An unpleasant, and likely messy, end",
    "You must have at least 5 Insanity Points to enter this career.",
    "NDM",
    8,
    15,
    43,
  ...
  [
    ...
    "Common Knowledge (Kislev);Consume Alcohol;Dodge Blow;Gamble or Gossip;Outdoor Survival;Perception;Search;Speak Language (Kislevian)",
    ...
    "None",
    "Bounty Hunter;Mercenary;Sergeant;Shieldbreaker;Veteran",
    "If this is your Starting Career, you are from Kislev",
    "WHFR",
    8,
    2,
    10,
  ...
  [
    ...
    "Concealment;Dodge Blow;Follow Trail;Heal or Search;Outdoor Survival;Perception;Scale Sheer Surface;Silent Move",
    "Marksman or Rover;Rapid Reload or Warrior Born",
    "Elfbow with 10 arrows;Light Armour (Leather Jack)",
    "Hunter;Messenger",
    "Hunter;Outrider;Scout;Vagabond;Veteran",
    "Only Elves of woodland origin can enter this career.",
    "WHFR",
    8,
    2,
    9,
  ...
  [
    ...
    "Academic Knowledge (Genealogy/Heraldry);Animal Care;Animal Training;Common Knowledge (any one);Dodge Blow;Outdoor Survival;Ride;Speak Language (any one)",
    ...
    "Knight;Noble;Squire",
    "Knight of the Realm",
    "Characters who are not male Bretonnian nobles must pretend to be so in order to become Knights Errant.",
    "KotG",
    8,
    5,
    11,
  ...
  [
    ...
    "Academic Knowledge (History);Academic Knowledge (Strategy/Tactics);Academic Knowledge (Theology);Command;Common Knowledge (Estalia or Tilea);Dodge Blow;Perception;Read/Write;Ride;Secret Language (Battle Tongue);Secret Signs (Templar);Speak Language (Estalian or Tilean)",
    ...
    "Anointed Priest (Myrmidia);Knight;Noble Lord;Priest (Myrmidia);Sergeant;Squire",
    "Captain;Champion;Explorer;Initiate;Knight of the Inner Circle",
    "",
    "SH",
    12,
    8,
  ...
  [
    ...
    "Academic Knowledge (Genealogy/Heraldry or Religion);Academic Knowledge (Strategy/Tactics);Animal Training;Charm;Command;Common Knowledge (any three);Dodge Blow;Perception;Read/Write;Ride;Secret Language (Battle Tongue);Secret Signs (Scout or Templar);Speak Language (Breton, Estalian, Kislevian, or Tilean)",
  ...
  [
    ...
    0,
    0,
    "The Fellowship of the Shroud believes in taking the battle to the enemy. Their very best warriors form an order known as the Knights of the Raven, and their mandate is very clear: destroy every Skeleton, Zombie, and Shade upon the earth and exterminate the necromancers and Vampires who summon them. Unlike their sister order the Black Guard, the Knights of the Raven are ruthless and aggressive, seeking out their enemy rather than waiting for Undead to come to them. At the moment, a great many of the knights are stationed in the town of Siegfriedhof of Stirland on the border of Sylvania. So far, they have only conducted raids, but as their numbers and intelligence grows, and the truth about Mannfred’s return becomes undeniable, they will begin a crusade to take that bleak land away from its dark lords once again.",
    "Academic Knowledge (History, Necromancy, Strategy/Tactics, Theology);Animal Training;Common Knowledge (any);Dodge Blow;Follow Trail;Perception;Read/Write;Ride;Secret Language (Battle Tongue);Speak Language (Breton or Kislevian)",
    ...
    "Black Guard;Knight;Knight of the Inner Circle",
    "Captain;Champion;Killer of the Dead;Knight of the Inner Circle;Witch Hunter",
    "",
    "NDM",
    10,
    11,
  ...
  [
    ...
    0,
    0,
    "Knights of the Realm are the backbone of the Bretonnian army and the most common members of its ruling elite. They have distinguished themselves in errantry and received a fief or a position in some other noble’s household. They are expected to honor and defend their lord, as well as the Realm. The knights described in Chapter Eight of Knights of the Grail are primarily Knights of the Realm.",
    "Academic Knowledge (Genealogy/Heraldry or Religion);Academic Knowledge (Strategy/Tactics);Command;Dodge Blow;Perception;Ride;Secret Language (Battle Tongue);Speak Language (any two)",
    ...
    "Knight Errant",
    "Captain;Courtier;Explorer;Faceless;Noble Lord;Politician;Questing Knight",
    "Characters who are not male Bretonnian nobles must pretend to be so in order to become Knights of the Realm.",
    "KotG",
    8,
    4,
    24,
  ...
  [
    ...
    "Hunter;Initiate (of Myrmidia);Mercenary;Militiaman;Outrider;Soldier;Woodsman",
    "Priest;Scout;Veteran",
    "",
    "TiT",
    10,
    5,
  ...
  [
    ...
    0,
    0,
    "Knights Panther are distinguished from other knights by their tall helmet crests topped by the image of a Beastman head. This is a change from the spotted great cat of their past, though they retain the distinctive pattern in their saddlecloths. To be accepted into this order, a squire must hunt down and kill a great forest cat single-handedly, placing its skin beneath his saddle when knighted. Thereafter, the Knight Panther divides his time between serving the Graf and going on private quests to destroy the minions of Chaos wherever they are found.",
    "Academic Knowledge (Genealogy/Heraldry);Academic Knowledge (Strategy/Tactics);Animal Training;Command;Common Knowledge (the Empire);Dodge Blow;Perception;Ride;Secret Language (Battle Tongue);Speak Language (any two)",
    ...
    "Knight;Noble Lord;Sergeant;Squire;Witch Hunter",
    "Captain;Champion;Knight of the Inner Circle;Veteran;Witch Hunter",
    "",
    "ToC",
    10,
    8,
  ...
  [
    ...
    "Academic Knowledge (Genealogy/Heraldry or Religion);Academic Knowledge (Strategy/Tactics);Dodge Blow;Perception;Ride;Secret Language (Battle Tongue);Speak Language (any two)",
    ...
    "Noble Lord;Pistolier;Sergeant;Squire;Vampire Hunter",
    "Captain;Initiate;Knight of the Inner Circle;Noble Lord;Vampire Hunter",
    "",
    "WHFR",
    7,
    4,
  ...
  [
    ...
    "Academic Knowledge (any two);Academic Knowledge (Theology);Charm;Common Knowledge (any two);Gossip;Haggle;Heal;Magical Sense;Perception;Read/Write;Ride or Swim;Speak Arcane Language (Magick);Speak Language (any two)",
    "Etiquette;Public Speaking;Resistance to Magic",
    "Prayer Book;Good Quality Vestments;Writing Kit",
    "Friar;Initiate;Priest",
    "Friar;Prelate;Priest ",
    "Lay Priests have access to the Skills and Talents of their cult (See Appendix V page 244)",
    "CC",
    13,
    3,
    27,
  ...
  [
    ...
    0,
    0,
    "Litigants are common sights both in Talabheim and all the major cities of the Old World. They write up legal documents, interpret the law, and represent individuals in court who are able to afford their fees. Litigants are almost universally reviled, except when someone is in legal trouble and needs assistance. Litigants need to be well versed in both the laws of the Empire and the region they plan to practice law, plus have a great deal of knowledge about day-to-day affairs. Even the lowest-born litigant is considered a “person of letters” to the general populace and may be asked to do things far beyond their training.",
    "Academic Knowledge (Genealogy/Heraldry or History);Academic Knowledge (Law);Blather or Charm;Common Knowledge (the Empire);Gossip or Haggle;Perception;Read/Write;Secret Language (Guild Tongue);Speak Language (Reikspiel)",
    "Dealmaker or Etiquette;Public Speaking;Savvy or Suave",
    "Book of Empire Laws;Writing Kit;Hand weapon",
    "Burgher;Envoy;Exciseman;Scribe;Student;Watchman",
    "Agitator;Demagogue;Guild Master;Merchant;Politician;Scholar",
    "If you are rolling randomly for your Starting Career, you can substitute Litigant for Scribe with your GM’s permission.",
    "TiT",
    9,
    3,
    9,
  ...
  [
    ...
    "Carcassonne Shepherd;Hunter;Peasant;Vagabond;Woodsman",
    "Carcassonne Shepherd;Herrimault;Outlaw;Outrider;Veteran;Yeoman",
    "Women can only enter this career if they are pretending to be men.",
    "KotG",
    6,
    4,
    9,
  ...
  [
    ...
    "Animal Care;Consume Alcohol;Follow Trail;Navigation;Perception;Ride or Sail;Search",
    ...
    "Berserker;Bondsman;Cult Acolyte;Freeholder;Reaver;Skald;Special",
    "Chaos Warrior (ToC);Mercenary;Reaver;Slaver;Warleader",
    "The Marauder career is open to Norsemen, Kurgan, and Hung. The latter two are generally horsemen, hence this career allows for Marauders that serve as horsemen. For details on these peoples, see Chapter XII: Hordes of Chaos in Tome of Corruption. (Special: Any character with at least one mutation and the GM’s permission may become a Marauder).",
    "ToC",
    7,
    3,
    11,
  ...
  [
    ...
    "Common Knowledge (the Wasteland) or Gamble;Consume Alcohol;Dodge Blow;Gossip or Secret Language (Battle Tongue);Intimidate;Row;Swim",
    "Disarm or Quick Draw;Strike Mighty Blow;Strike to Stun",
    "Bow or Crossbow with 10 Arrows or Bolts;Light Armour (Leather Jack);Shield;Grappling Hook;10 Yards of Rope",
    "Boatman;Fisherman;Seaman",
    "Mate;Outlaw;Sergeant;Smuggler;Thief",
    "During character creation, if you take Common Knowledge (the Wasteland), your character can be from the great port of Marienburg at your option.",
    "WHFR",
    7,
    3,
  ...
  [
    ...
    "Cat Burglar;Crime Lord;Fence;Highwayman;Racketeer;Spy",
    "Crime Lord;Explorer;Outlaw Chief;Targeteer",
    "",
    "WHFR",
    17,
    5,
  ...
  [
    ...
    "Academic Knowledge (Daemonology, Magic, Necromancy);Channelling;Common Knowledge (the Empire and any one);Gossip;Intimidate;Magical Sense;Perception;Read/Write;Ride;Search;Speak Arcane Language (Daemonic;Magick);Speak Language (any two);Torture",
    ...
    "Master Wizard;Spy;Vampire Hunter;Witch Hunter;Wizard Lord",
    "Characters with the Dark Magic Talent or any Dark Lore cannot enter this career; the magisters will not allow it and can usually tell. Usually.",
    "NDM",
    14,
    7,
    34,
  ...
  [
    ...
    "Academic Knowledge (Magic);Academic Knowledge (any two);Channelling;Charm or Intimidate;Common Knowledge (any two);Gossip or Ride;Magical Sense;Read/Write;Speak Arcane Language (Magick);Speak Arcane Language (Daemonic or Arcane Elf);Speak Language (any three",
    "Aethyric Attunement or Meditation;Dark Magic or Strong-minded;Fast Hands or Mighty Missile;Lesser Magic (any two)",
    "Trade Tools (Apothecary);Two magic items",
    "Journeyman Wizard",
    "Astrologer;Explorer;Scholar;Wizard Lord",
    "If you are Human you must continue to pay dues to your Order for the duration of this career. Most colleges charge Master Wizards a reduced rate of one crown in every twenty. Elves do not belong to the Orders of Magic, and thus owe nothing.",
    "WHFR",
    11,
    4,
    32,
  ...
  [
    ...
    "Command;Common Knowledge (any two);Consume Alcohol;Dodge Blow;Gamble;Gossip;Intimidate;Row;Sail;Speak Language (Breton, Kislevian, or Norse);Swim;Trade (Shipwright)",
    "Resistance to Disease;Seasoned Traveller;Street Fighting",
    "Light Armour (Leather Jack)",
    "Marine;Seaman",
    "Explorer;Merchant;Navigator;Sea Captain",
    "",
    "WHFR",
    12,
    3,
  ...
  [
    ...
    0,
    0,
    "The peasants of Bretonnia try to live their lives without noble interference. When the nobility get involved, people are beaten or hanged and food is taken, only making matters worse. However, the peasantry are far from living in a cooperative idyll, and disputes do arise between villages. Mediators are the peasants chosen to resolve those disputes. They live in one village and deal with the representatives, normally other Mediators, of villages with which they have a dispute. Mediators do not normally have the authority to make decisions, so they must try for a solution they can sell to their neighbours. Most Mediators are officially herders, as this gives them an excuse to be in odd places if the nobility find them. Whilst the overwhelming majority are men, a few female Mediators do exist.",
    "Animal Care;Charm;Common Knowledge (Bretonnia);Evaluate;Gossip;Haggle;Intimidate;Perception",
    "Dealmaker;Public Speaking;Seasoned Traveller;Suave",
    "A Wandering Lamb or a Wilful Pig",
    "Hunter;Man-at-Arms;Herrimault;Peasant;Rogue",
    "Demagogue;Herrimault;Rogue;Village Elder",
    "Only peasants may enter this career.",
    "KotG",
    8,
    4,
    8,
  ...
  [
    ...
    "Animal Care or Gamble;Common Knowledge (Bretonnia, Kislev, or Tilea);Dodge Blow;Drive or Ride;Gossip or Haggle;Perception or Search;Secret Language (Battle Tongue);Speak Language (Tilean) or Swim",
    ...
    "Bodyguard;Bounty Hunter;Demagogue;Fieldwarden;Kislevite Kossar;Militiaman;Miner;Norse Berserker;Outrider;Pit Fighter;Soldier;Thug;Watchman",
    "Bodyguard;Bounty Hunter;Outlaw;Sergeant;Sewer Jack;Shieldbreaker;Veteran",
    "During character creation, if you take Common Knowledge (Tilea) and Speak Language (Tilean), your character can be from Tilea at your option.",
    "WHFR",
    8,
    3,
    11,
  ...
  [
    ...
    " Charm;Common Knowledge (any two);Drive;Evaluate;Gossip;Haggle;Read/Write;Ride;Secret Language (Guild Tongue);Speak Language (Breton, Estalian, Kislevian, or Norse);Speak Language (Reikspiel);Trade (Merchant)",
    "Dealmaker or Streetwise;Super Numerate",
    "Town House;Warehouse;1,000 gc in coin or trade goods",
    "Artisan;Burgher;Captain;Envoy;Explorer;Farmer;Fisherman;Innkeeper;Mate;Scholar;Steward;Tradesman",
    "Farmer;Guild Master;Militiaman;Politician;Racketeer;Spy",
    "",
    "WHFR",
    12,
    2,
  ...
  [
    ...
    "Animal Care;Common Knowledge (the Empire or the Wasteland) or Gossip;Navigation;Outdoor Survival;Secret Signs (Scout);Perception;Ride;Speak Language (Reikspiel);Swim",
    "Orientation;Seasoned Traveller",
    "Light Armour (Leather Jack);Map Case;Riding Horse with Saddle and Harness or Pony (for Halflings);Shield",
    "Militiaman;Roadwarden;Servant",
    "Cartographer;Coachman;Herald;Kithband Warrior;Outrider;Roadwarden;Scout;Soldier",
    "",
    "WHFR",
    9,
    2,
  ...
  [
    ...
    "Animal Care;Dodge Blow;Drive or Swim;Gamble or Gossip;Outdoor Survival;Perception;Search;Trade (any one)",
    ...
    "Artisan;Bailiff;Burgher;Farmer;Fisherman;Merchant;Peasant;Tradesman;Woodsman",
  ...
  [
    ...
    "Charcoal-Burner;Hunter",
    "Charcoal-Burner;Engineer;Mercenary;Scout;Shieldbreaker;Smuggler",
    "",
    "WHFR",
    7,
    3,
  ...
  [
    ...
    0,
    0,
    "Monks are members of the mendicant orders who seek seclusion to better devote themselves to their faith. Some monks live completely alone as hermits, whereas others congregate with other monks and live in monasteries, which are usually located in remote areas of the Old World. Most religions have their own mendicant orders, although the strictures of Verena and Shallya tend to lend themselves more towards monasticism more than most. Monks spend their lives in study and prayer, debating the finer points of theology and illuminating religious scriptures.",
    "Academic Knowledge (any two);Academic Knowledge (Theology);Animal Care;Arcane Language (Magick);Common Knowledge (any two);Heal;Perception;Read/Write;Speak Language (any two);and Speak Language (Classical).",
    "Linguistics",
    "Prayer Book;Religious Symbol;Robes;Writing Kit",
    "Friar;Initiate;Physician;Scholar;Scribe;Student",
    "Abbot;Demagogue;Friar;Physician;Priest;Scholar;Steward;Zealot",
    "",
    "ToS",
    10,
    1,
  ...
  [
    ...
    "Academic Knowledge (Astronomy);Common Knowledge (any two);Navigation;Perception;Read/Write;Speak Language (Classical);Swim;Trade (Cartographer)",
    "Orientation",
    "6 Maps and Charts;Trade Tools (Navigator’s Instruments)",
    "Boatman;Cartographer;Dilettante;Fisherman;Mate;Scribe;Seaman",
    "Artisan;Cartographer;Explorer;Scholar;Sea Captain",
    "",
    "WHFR",
    8,
    1,
  ...
  [
    ...
    "Academic Knowledge (History or Strategy/Tactics);Academic Knowledge (Genealogy/Heraldry);Charm;Command;Common Knowledge (the mpire);Evaluate;Gossip;Perception;Read/Write;Ride;Speak Language (Classical);Speak Language (Reikspiel)",
    ...
    "Courtier;Knight;Knight of the Inner Circle;Politician;Sea Captain",
    "Captain;Knight;Scholar;Sea Captain",
    "",
    "WHFR",
    12,
    3,
  ...
  [
    ...
    0,
    0,
    "The Nobles are the ruling class of the Empire. They wield the power, they control the land, and they make the laws. The most important Noble families are those of Imperial Electors and of course the Emperor himself. There are hundreds of others though, and they all vie for more money and more power. Some seek their fortunes in war, others in business or politics. None would sully themselves by practicing a common trade. The most contemptible Nobles do nothing at all, merely live off their family wealth and attend an endless array of parties, dances, and gala events. The younger children of Noble houses, however, do not have it so easy. Since inheritance goes to the eldest, they must often make their own way in the world, even if it means slumming amongst the lower classes and falling in with adventurers and ne’er-do-wells.",
    "Blather or Command;Common Knowledge (the Empire);Consume Alcohol or Performer (Musician);Charm;Gamble or Gossip;Read/Write;Ride;Speak Language (Reikspiel)",
  ...
  [
    ...
    "Light Armour (Leather Jerkin);Bottle og Spirits;Great Weapon or Shield",
    "None",
    "Mercenary;Pit Fighter;Seaman;Sergeant;Veteran",
    "If this is your Starting Career, you are from Norsca.",
    "WHFR",
    6,
    4,
    11,
  ...
  [
    ...
    0,
    0,
    "Every band of brigands needs a leader. An Outlaw who shows he is both cunning and bold can rise to the level of Outlaw Chief. Commanding a lawless group of dangerous men is no easy task and the perilous forests of the Old World don’t make the job any easier. Outlaw Chiefs get their pick of the loot their band acquires, but they are also held responsible for every failure and their grasp on leadership is tenuous. Outlaw bands are notorious for not allowing any of their members to simply retire, which may make leaving the Chief’s post a difficult task.",
    "Academic Knowledge (Strategy/Tactics);Command;Common Knowledge (the Empire);Concealment;Follow Trail;Perception;Ride;Scale Sheer Surface;Secret Language (Battle Tongue);Secret Language (Thieves’Tongue);Secret Signs (Scout or Thief);Silent Move",
    ...
    "Crime Lord;Demagogue;Ghost Strider;Highwayman;Master Thief;Racketeer;Scout;Veteran",
    "Assassin;Captain;Crime Lord;Demagogue",
    "",
    "WHFR",
    12,
    5,
  ...
  [
    ...
    "Animal Care or Common Knowledge (the Empire);Concealment;Dodge Blows;Drive or Ride;Gossip or Secret Signs (Thief);Perception;Scale Sheer Surface;Set Traps or Swim;Silent Move",
    "Rover or Streetwise;Sharpshooter or Strike to Stun",
    "Bow with 10 Arrows;Light Armour (Leather Jerkin);Shield",
    "Agitator;Charlatan;Coachman;Ex-Convict;Hedge Wizard;Innkeeper;Marine;Mercenary;Militiaman;Peasant;Roadwarden;Rogue;Squire;Toll Keeper;Woodsman;Zealot",
    "Demagogue;Ex-Convict;Highwayman;Thief;Vagabond;Veteran",
    "",
    "WHFR",
    9,
    2,
  ...
  [
    ...
    "Bow or Crossbow with 10 Arrows or BOlts;Net;Whip;Lasso;Light Armour (Leather Jack);Shield;10 Yards or Rope;Riding Horse with Saddle and Harness",
    "Kithband Warrior;Messenger;Roadwarden;Soldier",
  ...
  [
    ...
    "Academic Knowledge (any one);Blather;Common Knowledge (Bretonnia, Kislev or Tilea);Common Knowledge (the Empire);Concealment;Gossip;Perception;Performer (Storyteller) or Trade (Artist);Read/Write;Speak Language (any one);Trade (Calligrapher or Merchant)",
    "Artistic or Public Speaking; Streetwise",
    "Writing Kit;Printing Press",
    "Agitator;Artisan;Burgher;Demagogue;Entertainer;Engineer;Messenger;Newssheet Vendor;Scholar;Scribe;Student",
    "Demagogue;Merchant;Politician;Scholar",
    "",
    "SoE",
    11,
    2,
  ...
  [
    ...
    0,
    0,
    "The peasantry makes up the preponderance of the Empire’s population. While the Nobles rule and the Burghers trade, the Peasants toil. They are farmers, labourers, and herdsman. In times of war, they fight and die for the Empire. Many Peasants seek a better life in the city, only to join the legion of beggars on the verge of starvation. The majority spends their whole lives in the village they were born in, surrounded by hostile country and only occasionally getting news of the outside world. While they are provincial and superstitious, the Peasants are the heart of the Empire.",
    "Animal Care or Charm;Animal Training or Swim;Charm Animal or Trade (Cook);Concelament;Drive or Trade (Bowyer);Gamble or Performer (Dancer or Singer);Outdoor Survival or Trade (Farmer);Row or Set Trap;Scale Sheer Surface or Silent Move",
    "Hardy or Rover;Flee! or Specialist Weapon Group (Sling)",
    "Sling or Quarterstaff;Leather Flask",
    "None",
    "Bone Picker;Charcoal-Burner;Farmer;Fisherman;Militiaman;Outlaw;Politician;Servant;Tradesman;Zealot",
    "",
    "WHFR",
    9,
    2,
  ...
  [
    ...
    "4 Healing Draughts;Trade Tools (Medical Instruments)",
    "Barber-Surgeon;Interrogator;Scholar;Student",
    "Astrologer;Friar;Guild Master;Scholar;Spy",
    "",
    "WHFR",
    8,
    3,
  ...
  [
    ...
    "Norse Berserker;Protagonist;Shieldbreaker;Thug",
    "Bounty Hunter;Mercenary;Protagonist;Troll Slayer;Veteran",
    "",
    "WHFR",
    2,
    7,
  ...
  [
    ...
    "Agitator;Bailiff;Captain;Charlatan;Courtier;Crime Lord;Demagogue;Farmer;Guild Master;Herald;High Priest;Merchant;Noble;Peasant;Prelate;Racketeer;Toll Keeper",
    "Courtier;Crime Lord;Demagogue;Noble Lord;Racketeer;Steward",
    "",
    "WHFR",
    13,
    4,
  ...
  [
    ...
    "Academic Knowledge (any two);Academic Knowledge (Theology);Blather;Charm;Common Knowledge (any two);Gossip;Heal;Intimidate;Perception;Performer (Storyteller);Ride or Swim;Secret Language (Guilder);Speak Arcane Language (Magick);Speak Language (any two)",
    "Master Orator;Etiquette;Linguistics;Seasoned Traveller;Schemer;Stout Hearted;Strong Minded",
    "Prayer Book;Best Quality Vestments;Relic of Faith",
    "Friar;Lay Priest;Priest",
    "Demagogue;Friar;Politician;Priest",
    "Prelates have access to the Skills and Talents of their cult (See Appendix V page 244)",
    "CC",
    14,
    7,
    34,
  ...
  [
    ...
    "Academic Knowledge (any one);Academic Knowledge (Theology);Channelling;Charm;Common Knowledge (any two);Gossip;Heal;Magical Sense;Perception;Read/Write;Ride or Swim;Speak Arcane Language (Magick);Speak Language (any two)",
    "Armoured Caster or Master Orator;Petty Magic (Divine);Strike to Injure or Strike to Stun",
    "Prayer Book;Writing Kit",
    "Flagellant;Friar;Initiate;Lay Priest;Prelate",
    "Anointed Priest;Flagellant;Lay Priest;Prelate;Scholar;Steward",
    "",
    "WHFR",
    13,
    3,
  ...
  [
    ...
    "Dodge Blow;Gossip or Haggle;Intimidate;Ride",
    ...
    "Bailiff;Bodyguard;Bounty Hunter;Estalian Diestro;Ex-Convict;Pit Fighter",
  ...
  [
    ...
    "Knight of the Realm",
    "Captain;Courtier;Explorer;Grail Knight;Faceless;Noble Lord;Politician",
    "Characters who are not male Bretonnian nobles must pretend to be so in order to become Questing Knights.",
    "KotG",
    12,
    1,
    40,
  ...
  [
    ...
    "Knuckle-dusters;Good Quality Clothing;Hat",
    "Bailiff;Bodyguard;Cat Burglar;Ex-Convict;Fence;Guild Master;Interrogator;Merchant;Politician;Protagonist;Spy;Thug",
    "Fence;Master Thief;Politician;Outlaw Chief",
    "",
    "WHFR",
    9,
    5,
  ...
  [
    ...
    0,
    0,
    "Born with a gift of gab and a desire to use it, Raconteurs are natural storytellers who can be found in taverns, inns, and salons anywhere in the Empire. No matter what the occasion – or even if it’s no occasion at all – the Raconteur has a ready story. He travels from place to place, witnessing marvellous things and weaving a thrilling tale about it all. In a society in which most people cannot read, the Raconteur is both a source of news and entertainment, mixing witty repartee and cutting wit into his stories. To gain his news, a Raconteur might find himself travelling with armies and adventuring bands in the hope of seeing (and surviving) something new and exciting, something that will earn him a few rounds of drinks and a healthy audience at the local inn. Not all Raconteurs enjoy the adventurous life, however. Some stay comfortably where they are and make it all up.",
    "Blather;Charm;Common Knowledge (any one);Gossip;Performer (Comedian);Performer (Storytelling);Read/Write;Speak Language (any one)",
    "Etiquette or Hardy;Public Speaking;Seasoned Traveller",
    "Best Clothing;Outrageous Hat",
    "Agitator;Camp Follower;Entertainer;Rogue;Seaman;Soldier;Student;Vagabond",
    "Charlatan;Courtier;Demagogue;Entertainer;Herald;Initiate;Rapscallion;Rogue",
    "",
    "SH",
    8,
    3,
  ...
  [
    ...
    "Charm;Common Knowledge (any two);Consume Alcohol;Dodge Blow;Evaluate;Gamble;Gossip;Lip Reading;Perception;Search;Sleight of Hand;Swim",
    ...
    "Dilettante;Gambler;Raconteur;Vagabond",
    "Charlatan;Duellist;Fence;Highwayman;Spy",
    "",
    "CC",
    12,
    4,
  ...
  [
    ...
    "Animal Care;Animal Trainier;Concealment;Perception;Search;Set Trap;Silent Move",
    ...
    "Grave Robber;Jailer;Runebearer;Tomb Robber",
    "Animal Trainer;Bone Picker;Cat Burglar;Grave Robber;Jailer;Shieldbreaker;Thief",
    "",
    "WHFR",
    7,
    4,
  ...
  [
    ...
    "Common Knowledge (Bretonnia, the Empire, Lustria, Norsca, Southlands, Tilea;or the Wasteland);Consume Alcohol;Dodge Blow;Row;Sail;Scale Sheer Surface;Speak Language (Breton, Estalian, Reikspiel, or Tilean);Swim",
    ...
    "Berserker;Bondsman;Marauder;Seaman;Skald;Warleader;Whaler",
    "Marine;Mate;Mercenary;Navigator;Slaver;Ulfwerenar (see ToC page 146);Veteran;Warleader",
    "",
    "ToC",
    9,
    3,
  ...
  [
    ...
    "Common Knowledge (The Empire or Kislev);Gossip or Speak Language (Kislevite);Navigation;Outdoor Survival or Sail;Perception;Row;Search;Secret Signs (Scout)",
    "Orientation or Very Strong;Specialist Weapon (Gunpowder)",
    "Pistol with Powder and Ammunition for 10 Shots;Light Armour (Leather Jack);Row Boat;Shield;Uniform;10 Yards of Rope",
    "Boatman;Ferryman;Marine;Roadwarden",
    "Boatman;Marine;Roadwarden;Seaman;Sergeant;Smuggler;Toll Keeper;Verenean Investigator;Wrecker",
    "If you are rolling randomly for your Starting Career, you can substitute Riverwarden for Roadwarden with your GM’s approval.",
    "WC",
    8,
    2,
    11,
  ...
  [
    ...
    0,
    0,
    "The Empire consists of pockets of civilisation tenuously connected to each other by roads and rivers. Much of the land is heavily forested, and such terrain is home to bandits, Mutants, Beastmen, and Goblins. Merely travelling from one city to another is an adventure, despite the constant vigilance of the Roadwardens. These lawmen patrol the roads and tracks of the Empire, protecting travellers and their goods. Since their numbers are small, they work with local militia and Soldiers to deal with larger threats. Most of the time though, it is up to small groups of Roadwardens to deal with all but the worst hazards. ",
    "Animal Care;Common Knowledge (the Empire) or Gossip;Drive;Follow Trail or Secret Signs (Scout);Navigation;Outdoor Survival;Perception;Ride;Search",
    "Quick Draw or Rapid Reload;Specialist Weapon Group (Gunpowdwer)",
    ...
    "Coachman;Ferryman;Messenger;Outrider;Watchman",
    "Highwayman;Messenger;Outlaw;Outrider;Scout;Sergeant;Toll Keeper",
    "",
    "WHFR",
    9,
    2,
  ...
  [
    ...
    0,
    0,
    "If Rogues have a creed, it is this: never do an honest day’s work if you can avoid it. These fast-talking con men use their charm and luck to make their way in the world. Some work as bawds, professional guides to the dens of vice and inequity to be found in any city. Others are professional gamblers or raconteurs. All Rogues favour their wits over their swords, and they always have a ready story on their lips. While Rogues often have one city as home turf, some travel from place to place, profiting from elaborate schemes and then moving on. The most skilled Rogues go undetected. Their lies are so convincing that even those they have swindled never realize it was a con.",
    "Blather;Charm;Evaluate;Gamble or Secret Signs (Thief);Gossip or Haggle;Perception;Performer (Actor or Storyteller);Search or Secret Language (Thieves' Tongue);Speak Language (Reikspiel)",
    "Flee! or Streetwise;Luck or Sixth Sense;Public Speaking",
    "One set of Best Craftsmenship Clothing or Dice or Deck of Cards;1d10 gc",
    "Agitator;Assassin;Duelist;Entertainer;Envoy;Estalian Diestro;Noble;Seaman;Thief;Valet",
    "Charlatan;Demagogue;Entertainer;Ex-Convict;Outlaw;Servant;Thief",
    "",
    "WHFR",
    9,
    3,
  ...
  [
    ...
    "Shieldbreaker",
    "Apprentice Runesmith;Rat Catcher;Scout;Sewer Jack;Shieldbreaker;Tomb Robber;Veteran",
    "Only Dwarfs can enter this career.",
    "WHFR",
    6,
    5,
  ...
  [
    ...
    "Academic Knowledge (any four);Charm;Command;Common Knowledge (any three);Dodge Blow;Evaluate;Gossip;Intimidate;Perception;Read/Write;Runecraft;Speak Arcane Language (Arcane Dwarf);Speak Language (any three);Trade (any two)",
  ...
  [
    ...
    "Academic Knowledge (any three);Common Knowledge (any three);Evaluate or Trade (Cartographer);Perception;Read/Write;Speak Language (any three);Speak Language (Classical)",
    "Linguistics ",
    "Writing Kit",
    "Anointed Priest;Apprentice Wizard;Cartographer;Friar;High Priest;Journeyman Wizard;Master Wizard;Navigator;Noble Lord;Physician;Priest;Scribe;Sea Captain;Student",
    "Apprentice Wizard;Explorer;Friar;Litigant;Merchant;Physician;Steward",
    "",
    "WHFR",
    7,
    1,
  ...
  [
    ...
    "Flagellant",
    "Champion;Initiate;Interrogator;Witch Hunter",
    "You may enter this career even if the insanity you had as a Flagellant has been cured.",
    "ToS",
    4,
    7,
    37,
  ...
  [
    ...
    "Bounty Hunter;Champion;Charcoal-Burner;Coachman;Fieldwarden;Hunter;Kithband Warrior;Messenger;Miner;Outrider;Roadwarden;Runebearer;Vagabond;Woodsman",
    "Explorer;Outlaw Chief;Sergeant;Vampire Hunter;Ghost Strider",
    "",
    "WHFR",
    12,
    5,
  ...
  [
    ...
    "Academic Knowledge (any one);Common Knowledge (the Empire) or Gossip;Perception;Read(Write;Secret Language (Guild Tongue);Speak Language (Breton);Speak Language (Classical);Speak Language (Reikspiel or Tilean);Trade (Calligrapher)",
    "Linguistics",
    "Knife;A Pair of Candles;Wax;5 matches;Illuminated Book;Writing Kit",
    "Apprentice Wizard;Cartographer;Initiate",
    "Apprentice Runesmith;Agitator;Apprentice Wizard;Initiate;Navigator;Scholar",
    "",
    "WHFR",
    9,
    1,
  ...
  [
    ...
    0,
    0,
    "Sea Captains roam the oceans of the Old World seeking profit and adventure over the next horizon. Strictly honourable Sea Captains are far-travelling traders who only sail in search of the most profitable markets for their goods. The most dangerous are bloodthirsty pirates, attacking other ships for plunder and leaving no survivors. Most Sea Captains fall somewhere in between. On a sea-going vessel a Captain’s word is law. Sailors, however, are a fractious lot; a Sea Captain must be clever, strong-willed and a bit ruthless to stay in command. The most famous Sea Captains come from Marienburg, Tilea, and the Elven island of Ulthuan.",
    "Academic Knowledge (Strategy/Tactics);Animal Training;Command;Common Knowledge (any three);Dodge Blow;Perception;Sail;Speak Language (any three);Swim;Trade (Cartographer or Shipwright)",
    "Disarm;Lightning Parry or Swashbuckler;Seasoned Traveller;Specialist Weapon Group (Fencing);Strike Mighty Blow",
    "Rapier;Light Armour (Leather Jack);Telescope;Ship",
    "Explorer;Mate;Navigator;Noble Lord",
    "Explorer;Noble Lord;Scholar;Spy",
    "",
    "WHFR",
    10,
    5,
  ...
  [
    ...
    "Blather or Speak Arcane Language (Daemonic or Magick);Channelling or Performer (Palm Reader);Charm Animal or Public Speaking;Magical Sense or Perception",
    "Hedge Magic or Keen Senses;Luck or Petty Magic (Hedge);Public Speaking",
    "Instruments of Divination (dice, cards, a chicken, etc.)",
    "Hedge Wizard;Skald",
    "Agitator;Charlatan;Maledictor (ToC);Vagabond;Vitki (ToC);Witch",
    "",
    "ToC",
    4,
    3,
  ...
  [
    ...
    0,
    0,
    "Sergeants are professional warriors who’ve managed to impress either a Captain or a Noble with their ability to command men in battle. They lead small units of Soldiers, Militiamen, Mercenaries and Roadwardens, ensuring that orders are carried out to the letter. Some lead by setting a sterling example, others by terrifying their troops into quick obedience. Those who make their troopers lives a priority tend to be the most popular. The best Sergeants earn the respect of their Soldiers with their own blood and courage. They are often called upon to lead their men into danger and they swiftly become experts at assessing the capabilities of others.",
    "Academic Knowledge (Strategy/Tactics);Command;Common Knowledge (any two);Dodge Blow;Gossip;Intimidate;Perception;Ride or Swim;Secret Language (Battle Tongue);Speak Language (Tilean)",
    "Menacing or Seasoned Traveller;Street Fighting or Wrestling;Strike Mighty Blow;Strike to Stun",
    "Medium Armour (Full Mail Armour);Shield",
    "Assassin;Champion;Duellist;Highwayman;Judicial Champion;Kislevite Kossar;Marine;Mercenary;Militiaman;Norse Berserker;Pistolier;Roadwarden;Scout;Shieldbreaker;Soldier;Squire;Targeteer;Veteran;Watchman",
    "Captain;Duellist;Judicial Champion;Knight",
    "",
    "WHFR",
    10,
    4,
  ...
  [
    ...
    "Animal Care or Trade (Cook);Blather;Dodge Blow;Drive or Search;Evaluate or Haggle;Gossip;Perception;Read/Write or Sleight of Hand",
    ...
    "Camp Follower;Peasant;Rogue",
    "Agitator;Burgher;Camp Follower;Innkeeper;Messenger;Spy;Thief;Valet",
    "",
    "WHFR",
    8,
    3,
  ...
  [
    ...
    0,
    0,
    "The Sewer Jacks are a specialised force, under the command of the City Watch, whose purpose is to keep the sewer system and the Undercity (see AoM p. 28) secure. A certain amount of courage is required to police the fetid tunnels beneath Middenheim, but the Sewer Jacks are less choosy in their recruiting policy than the other armed forces – partly because there is nearly always a shortage of volunteers for this dangerous and unpleasant duty. A typical patrol of Sewer Jacks is 6-8 strong.",
    "Concealment;Dodge Blow;Follow Trail or Secret Signs (Scout);Perception;Scale Sheer Surface;Search or Swim;Silent Move",
    "Quick Draw or Resistance to Disease;Tunnel Rat",
    "Crossbow with 10 bolts;Lantern;Light Armour (Leather Jack)",
    "Jailer;Militiaman;Peasant;Rat Catcher;Shieldbreaker;Watchman",
    "Mercenary;Rat Catcher;Sergeant;Shieldbreaker;Smuggler;Veteran;Watchman",
    "If you are rolling randomly for your Starting Career, you can substitute Sewer Jack for Watchman with your GM’s permission.",
    "AoM",
    7,
    2,
    10,
  ...
  [
    ...
    "Kislevite Kossar;Mercenary;Miner;Rat Catcher;Runebearer;Smuggler;Tomb Robber",
    "Pit Fighter;Runebearer;Sergeant;Sewer Jack;Smuggler;Tomb Robber;Veteran",
    "Only Dwarfs can have Shieldbreaker as a Starting Career.",
    "WHFR",
    5,
    5,
    10,
  ...
  [
    ...
    "Academic Knowledge (History);Blather;Charm;Common Knowledge (Norsca);Common Knowledge (Chaos Wastes);Gossip;Perception;Performer (any two);Speak Language (Norse);Speak Language (any two) or Ventriloquism",
    "Mimic;Public Speaking;Savvy;Suave",
    ...
    "Bondsman;Entertainer",
    "Agitator;Berserker;Burgher;Freeholder;Marauder;Mercenary;Reaver;Rogue;Seer",
    "",
    "ToC",
    10,
    4,
  ...
  [
    ...
    "Marauder;Merchant;Reaver",
    "Captain;Chaos Warrior (ToC);Outlaw Chief;Seaman",
    "",
    "ToC",
    9,
    5,
  ...
  [
    ...
    "Drive;Evaluate;Gossip or Secret Language (Thieves' Tongue);Haggle;Perception;Row;Search;Silent Move;Speak Language (Breton or Kislevian) or Secret Signs (Thief);Swim",
    "Dealmaker or Streetwise",
    "Light Armour (Leather Jack);2 Torches;Draft Horse and Cart or Rowing Boat",
    "Bailiff;Boatman;Bone Picker;Camp Follower;Coachman;Engineer;Ferryman;Innkeeper;Marine;Miner;Seaman;Shieldbreaker",
    "Boatman;Charlatan;Ex-Convict;Fence;Ferryman;Seaman;Shieldbreaker;Thief",
    "",
    "WHFR",
    10,
    1,
  ...
  [
    ...
    "Animal Care or Heal;Common Knowledge (the Empire) or Perception;Dodge Blow;Drive or Ride;Gamble or Gossip;Intimidate",
    "Disarm or Quick Draw;Sharpshooter or Strike Might Blow;Specialist Weapon Group (Gunpowder or Two-handed);Strike to Injure or Rapid Reload;Strike to Stun or Mighty Shot",
    "Great Weapon (halberd) or Firearm with Ammunition for 10 shots;Shield;Light Armour (Full Leather Armour);Uniform",
    "Flagellant;Hunter;Messenger;Toll Keeper;Watchman",
  ...
  [
    ...
    "Academic Knowledge (Genealogy/Heraldry) or Common Knowledge (Bretonnia);Animal Care;Animal Training;Charm or Gossip;Dodge Blow;Ride;Speak Language (Breton or Reikspiel)",
    ...
    "If, during character creation, you take Common Knowledge (Bretonnia) and Speak Language (Breton), your character can be from Bretonnia at your option.",
    "WHFR",
    7,
    3,
    10,
  ...
  [
    ...
    "Animal Care;Animal Training or Trade (Cook);Charm Animal or Consume Alcohol;Common Knowledge (Troll Country);Concealment or Heal;Follow Trail or Trade (Bowyer);Navigation or Secret Signs (Scout);Outdoor Survival;Perception or Performer (Dancer);Ride",
    "Hardy or Rover",
    "Kislevite horse with saddle and harness;week of rations;skins of water and koumiss;a yurta;leather jacks and leggings;Kislevite horse bow with a quiver of 10 arrows.",
    "Any",
    "Ataman;Horse Archer;Horse Master;Kossar;Outlaw;Scout;Vagabond",
    "You must be Ungol and you must be a member of a nomadic krug",
    "RotIQ",
    10,
    1,
    10,
  ...
  [
    ...
    "Consume Alcohol or Gamble;Dodge Blow or Scale Sheer Surface;Gossip;Perception or Search;Performer (Singer);Secret Language (Guild Tongue);Swim",
    "Lightning Reflexes or Sturdy;Very Strong",
    "Light Armour (Leather Jack);Watch Cap in Gang Colours;10 Yards of Rope;1d10 Wooden Spikes",
    "Boatman;Peasant",
    "Boatman;Foreman;Marine;Merchant;Smuggler;Thief;Thug;Tradesman",
    "If you are rolling randomly for your Starting Career, you can substitute Stevedore for Boatman with your GM’s approval.",
    "WC",
    7,
    2,
    9,
  ...
  [
    ...
    "2 Sets of Best Craftsmenship Noble’s Garb;Writing Kit",
    "Courtier;Farmer;Politician;Priest;Scholar;Valet",
    "Crime Lord;Fence;Merchant;Noble",
    "",
    "WHFR",
    14,
    2,
  ...
  [
    ...
    "Common Knowledge (Kislev) or Perception;Consume Alcohol;Dodge Blow;Gamble or Gossip;Speak Language (Kislevarin)",
    ...
    "uniform;leather jerkin;leggings and helmet;berdysh pole-arm;firearm;powder and 10 shots",
    "Kossar;Watchman",
    "Bounty Hunter;Chekist;Mercenary;Sergeant;Veteran;Watchman;Winged Lancer",
    "",
    "RotIQ",
    5,
    4,
  ...
  [
    ...
    "Academic Knowledge (Necromancy);Charm;Drive or Ride;Evaluate;Gossip;Haggle;Hypnotism or Trade (Apothecary);Performer (any);Secret Signs (Astrologer or Ranger);Sleight of Hand;Speak Language (Strigany)",
    "Sixth Sense;Rover or Seasoned Traveller",
    "Deck of Cards;Eldritch Jewellery",
    "None",
    "Astrologer;Bone Picker;Charlatan;Entertainer;Hedge Wizard;Rogue;Seer;Thief",
    "Strigany mystic is only available to those of Strigany blood. Being of that blood imposes a –10% penalty to all Fellowship Tests when dealing with a person of the Empire. With your GM’s permission, you may substitute Strigany mystic for vagabond when rolling for your Starting Career. If you have the WFRP Companion, you may apply the River Strigany Traits to your Strigany mystic.",
    "NDM",
    11,
    2,
    10,
  ...
  [
    ...
    "Boatman;Bone Picker;Ferryman;Frogwife;Hunter;Militiaman;Peasant",
    "Grail Pilgrim;Herrimault;Man-at-Arms;Outlaw;Thug;Vagabond;Village Elder;Yeoman",
  ...
  [
    ...
    "Bounty Hunter;Hunter;Ghost Strider;Master Thief;Vampire Hunter;Veteran",
  ...
  [
    ...
    "Common Knowledge (any one);Dodge Blow;Gossip;Intimidate;Perception;Search",
    "Cool Headed or Stout Hearted;Strike Mighty Blow;Strike to Stun",
    "Light Armour (Leather Jack);Robes or Uniform",
    "Grave Warden;Initiate;Militiaman;Watchman;Zealot",
  ...
  [
    ...
    "Coolheaded or Lightning Reflexes;Disarm;Resistance to Posion or Quick Draw;Strike to Injure or Wrestling;Strike to Stun",
    "Knuckle-dusters;Medium Armour (Mail Shirt and Leather Jack)",
    "Ex-Convict;Marine;Protagonist",
    "Bodyguard;Ex-Convict;Interrogator;Mercenary;Pit Fighter;Racketeer",
    "",
    "WHFR",
    5,
    5,
  ...
  [
    ...
    0,
    0,
    "Tomb Robbers differ from Grave Robbers in that they are interested in the valuables to be found in burial sites rather than the bodies themselves. Although very few graves in the Old World include valuable goods these days, there are many ancient burial sites that contain priceless treasures. Tomb Robbers are experts in locating such sites and plundering their riches. Secret tombs are usually in dangerous and inaccessible areas. Those within the Empire’s borders are revered and protected by local inhabitants, so accessing these sites can be just as dangerous. Clever traps and deceptions protect the richest tombs and skilled Tomb Robbers must learn to disarm or bypass them. Few survive long enough to raid more than one tomb. ",
    "Common Knowledge (the Empire) or Secret Signs (Thief);Concealment or Outdoor Survival;Evaluate;Perception;Pick Lock or Silent Move;Read/Write;Scale Sheer Surface;Search;Speak Language (Classical or Khazalid or Eltharin)",
    "Luck or Sixth Sense;Trapfinder or Tunnel Rat",
    "Light Armour (Leather Jack);Crowbar;Lantern;Lamp Oil;10 Yards of Rope;2 Sacks",
    "Runebearer;Shieldbreaker;Thief",
    "Fence;Rat Catcher;Shieldbreaker;Thief;Vampire Hunter",
    "",
    "WHFR",
    9,
    2,
  ...
  [
    ...
    0,
    0,
    "Tradesmen are skilled labourers and craftsmen. Although they tend to cluster together in cities, they can also be found in villages across the Empire. They provide many of the goods used by Merchants when trading abroad, and are valued as an important part of the Empire’s economy. Tradesmen include apothecaries, armourers, bowyers, brewers, calligraphers, carpenters, cartographers, gem cutters, gunsmiths, herbalists, peddlers, shipwrights, smiths, stoneworkers, tailors, and weaponsmiths. Each trade has its own guild, though not all guilds have local chapters.",
    "Animal Care or Gossip;Drive;Haggle;Evaluate;Perception;Read/Write;Secret Language (Guild Tongue);Trade (any);Trade (any)",
    "Dealmaker or Savvy",
    "Light Armour (Leather Jerkin), 1d10 gc",
    "Barber-Surgeon, Burgher, Camp Follower, Dilettante, Peasant, Watchman",
    "Artisan, Cartographer, Engineer, Envoy, Farmer, Merchant, Militiaman, Zealot",
    "",
    "WHFR",
    9,
    1,
  ...
  [
    ...
    "Pit Fighter",
    "Giant Slayer",
    "Only Dwarfs can join this career. Taking the Slayer’s path is a sure route to death. Think carefully before entering this career.",
    "WHFR",
    3,
    6,
    11,
  ...
  [
    ...
    "Common Knowledge (Bretonnia;Estalia;Kislev;or Tilea);Gossip or Secret Language (Ranger Tongue or Thieves’ Tongue);Haggle or Swim;Heal or Perception;Navigation;Outdoor Survival;Performer (Dancer;Singer;or Storyteller) or Secret Signs (Ranger or Thief);Silent Move",
    "Fleet Footed or Rover;Marksman or Orientation;Seasoned Traveller",
    "Trappings: Back Pack;Rations (1 week);Tent;Water Skin",
    "Barber-Surgeon;Camp Follower;Cartographer;Cat Burglar;Charcoal-Burner;Entertainer;Envoy;Ex-Convict;Fieldwarden;Hedge Wizard;Kithband Warrior;Outlaw;Soldier;Woodsman",
    "Bone Picker;Entertainer;Friar;Rapscallion;Scout;Thief;Woodsman",
    "",
    "WHFR",
    13,
    3,
  ...
  [
    ...
    "Academic Knowledge (History or Necromancy);Common Knowledge (the Empire);Concealment;Dodge Blow;Follow Trail;Perception;Scale Sheer Surface;Shadowing;Search;Silent Move;Speak Language (Classical)",
    ...
    "Bounty Hunter;Field Warden;Ghost Strider;Knight;Scout;Tomb Robber",
    "Demagogue;Initiate;Knight;Targeteer;Witch Hunter",
    "",
    "WHFR",
    11,
    6,
  ...
  [
    ...
    "Academic Knowledge (Law);Academic Knowledge (any two);Command;Common Knowledge (Empire);Common Knowledge (any one);Concealment;Disguise;Follow Trail;Gossip;Perception;Pick Lock;Read/Write;Search;Shadowing;Silent Move;Sleight of Hand;Secret Signs (any one);Speak Language (Classical);Speak Language (Reikspiel);Speak Language (any one)",
    ...
    "Bounty Hunter;Cat Burglar;Dilettante;Initiate (Verena);Priest (Verena);Roadwarden;Thief;Watchman;Scholar;Spy;Witch Hunter",
    "Initiate (Verena);Scholar;Spy;Witch Hunter",
    "",
    "SH",
    20,
    4,
  ...
  [
    ...
    "Flagellant;Kislevite Kossar;Kithband Warrior;Mercenary;Norse Berserker;Outlaw;Pistolier;Pit Fighter;Runebearer;Shieldbreaker;Soldier;Squire",
    "Champion;Farmer;Judicial Champion;Outlaw Chief;Sergeant;Targeteer",
    "",
    "WHFR",
    8,
    4,
  ...
  [
    ...
    "Academic Knowledge (Engineering);Academic Knowledge (Strategy/Tactics);Common Knowledge (Bretonnia);Evaluate;Gossip;Haggle;Perception;Trade (Carpenter);Trade (Stoneworker)",
    "Lightning Reflexes;Specialist Weapon Group (Engineer)",
    "Fortifications to look after;trade tools",
    "Man-at-Arms;Peasant;Tradesman",
    "Spy;Steward;Yeoman",
    "Only peasants may become Wall Wardens. Women may only become Wall Wardens if disguised as men.",
    "WHFR",
    9,
    2,
    23,
  ...
  [
    ...
    "Command;Consume Alcohol;Dodge Blow;Intimidate;Perception",
    ...
    "Bondsman;Marauder;Reaver",
    "Captain;Chaos Warrior†;Champion;Veteran",
  ...
  [
    ...
    0,
    0,
    "Witches that use Dark Magic and embrace its power can become Warlocks if they survive its perils long enough to gain the required knowledge. They may not realize it at first, but this is a dangerous path that leads almost inevitably to corruption. They are the bogeymen of the witch hunters, the spellcasters that are a danger to themselves and to others. Warlocks tend to be either Daemonologists or Necromancers. Since they are selftaught and so much of their magic is based on experimentation, however, most Warlocks have unique views of magic and the world. It is this individuality that makes it so hard for the witch hunters to root them out.",
    "cademic Knowledge (Daemonology or Necromancy);Channelling;Charm;Common Knowledge (any three);Concealment;Disguise;Gossip;Haggle;Heal;Hypnotism or Read/Write;Magical Sense;Perception;Ride or Swim;Search;Trade (Apothecary or Herbalist)",
    "Dark Lore (any one);Dark Magic;Hardy or Very Resilient",
    "Lucky Charm",
    "Witch",
    "Apprentice Wizard;Charlatan;Outlaw;Scribe;Vagabond",
    "You must have at least one insanity point and learned at least two spells through your Witchcraft talent before you can enter this career.",
    "WoS",
    15,
    3,
    28,
  ...
  [
    ...
    0,
    0,
    "Whilst all priests are expected to bear arms in the defence of their temple and faith, and most are at least profcient in combat, only a few march to battle alongside their templars and the Imperial army. These warrior priests have a threefold responsibility: ministering to the faithful amongst the army, offering spiritual and tactical advice to the army’s leadership, and smiting the unfaithful in battle. When war comes to the temple, a cult’s warrior priests take charge of its defence, marshalling the rest of the cult to repel attackers. Warrior priests are usually members of holy orders, such as the Sigmarites of the Order of the Silver Hammer. Most warrior priests come from the cults of Sigmar, Ulric, and Myrmidia, although other cults are not without a few token militant brethren.",
    "Academic Knowledge (Strategy/Tactics);Academic Knowledge (Teology);Channelling;Common Knowledge (any two);Dodge Blow;Heal;Magical Sense;Ride;Secret Language (Battle Tongue);Speak Arcane Language (Magick);Speak Language (any one)",
    ...
    "Anointed Priest;Prelate;Priest",
    "High Priest;Knight;Prelate;Witch Hunter",
    "Followers of Shallya may not become Warrior Priests.  *Warrior Priests tend to wield weapons sacred to their faith;typically a greathammer;greatsword or polearm. Warrior Priests of Taal and Rhya may substitute a longbow.",
    "ToS",
    11,
    5,
    33,
  ...
  [
    ...
    "Coolheaded or Savvy;Disarm or Street Fighting;Strike Mightly Blow;Strike to Stun",
    "Light Armour (Leather Jack);Lantern and Pole;Lamp Oil;Uniform",
    "Jailer;Soldier",
    "Mercenary;Racketeer;Roadwarden;Sergeant;Sewer Jack;Soldier;Tradesman",
    "",
    "WHFR",
    7,
    4,
  ...
  [
    ...
    0,
    0,
    "Whaling is an important trade for Norsca, and Whalers are respected even among the warriors. Swimming through the dark currents of the Sea of Chaos are massive whales, many of which bear strange markings, and odd colouration, twisted and warped as they are by the power of Chaos. These monsters can capsize ships and swallow hundreds of men in a single gulp. Thus, Whalers must be made of sterner stuff than ordinary fshermen.",
    "Consume Alcohol;Navigation;Perception;Row;Sail;Swim",
    ...
    "Fisherman;Reaver;Seaman",
    "Freeholder;Marauder;Navigator;Reaver;Veteran",
    "",
    "ToC",
    6,
    5,
  ...
  [
    ...
    "Academic Knowledge (Strategy/Tactics);Animal Care or Dodge Blow;Command or Navigation;Common Knowledge (Kislev or Troll Country);Consume Alcohol;Outdoor Survival;Perception;Ride;Secret Language (Battle Tongue);Speak Language (Kislevarin)",
    "Hardy or Very Resilient;Specialist Weapon Group (Cavalry);Strike Mighty Blow or Strike to Injure",
    "At least full suits of mail, though some accent their armour with bits of plate;From their backs ﬂy winged banners;Kislevite warhorse equipped with saddles and harnesses;lances;scimitars (Hand Weapons);shields;at least two javelins;a bottle of kvas",
    "Horse Master, Kossar, Noble, Outrider, Peasant, Streltsi",
    "Captain, Horse Master, Scout, Veteran",
    "",
    "RotIQ",
    10,
    3,
  ...
  [
    ...
    "Academic Knowledge (History or Spirits);Charm or Intimidate;Command;Common Knowledge (Kislev or Troll Country);Consume Alcohol or Gossip;Heal;Magical Sense;Perception;Performer (Storyteller);Prepare Poison or Trade (Apothecary or Herbalist);Speak Language (Ungol)",
    "Coolheaded or Savvy",
    "Antitoxin kit;healing draught;healing poultice;a skin of koumiss to ease other sorts of hurts, a number of small charms that include bits of bone, locks of hair, unusual stones, and so on;They mark their station with the tell-tale shawl, a beautifully woven length of cloth they wear draped from their heads or around their necks.  ",
    "Any",
    "Demagogue;Hag Witch;Hedge Witch;Politician;Steppes Nomad",
    "You must be an Ungol female to enter this career.",
    "RotIQ",
    11,
    1,
  ...
  [
    ...
    "Academic Knowledge (Magic);Academic Knowledge (Necromancy);Academic Knowledge (Teology);Charm;Command;Common Knowledge (the Empire);Gossip;Intimidate;Perception;Ride;Search;Silent Move;Speak Language (any one)",
    "Lightning Parry;Lightning Reﬂexes or Marksman;Menacing;Public Speaking;Sixth Sense;Specialist Weapon Group (Crossbow);Specialist Weapon Group (Entangling);Specialist Weapon Group (Trowing);Stout-hearted;Strike Mighty Blow",
    "Crossbow Pistol with 10 bolts;Best Craftsmenship Hand Weapon;4 Trowing Knives/Stars;Heavy Armour (Full Plate Armour);10 Yards of Rope",
    "Anointed Priest;Assassin;Champion;High Priest;Judicial Champion;Knight of the Inner Circle;Vampire Hunter",
    "Captain;Champion;Demagogue;Initiate;Knight of the Inner Circle",
    "",
    "WHFR",
    13,
    10,
  ...
  [
    ...
    0,
    0,
    "Within the Empire, the Lords of the Magical Orders are powerful individuals indeed. They no longer see the world as others do, however, having dedicated their very souls to magic. They now embody their chosen Lore in word, deed and physical form. Should an Elf attain this level of magical skill, he is considered to have completed his minor magic apprenticeship, and is ready to travel to the towers of Hoeth to become a High Mage.",
    "Academic Knowledge (Magic);Academic Knowledge (any three);Channelling;Charm or Intimidate;Common Knowledge (any three);Magical Sense;Read/Write;Speak Arcane Language (Magick);Speak Arcane Language (Daemonic or Arcane Elf);Speak Language (any four)",
    "Aethyric Attunement or Mighty Missile;Dark Magic or Meditation;Fast Hands or Hardy;Lesser Magic (any two)",
    "Three magic items;12 Grimoires",
    "Master Wizard",
    "Explorer;Guild Master",
    "Wizard Lords no longer pay dues to their Order. They are, however, charged with preserving the purity of their order, rooting out Chaos worshippers, and ensuring the Orders receive the respect (and monies) due to them.",
    "WHFR",
    10,
    4,
    42,
  ...
  [
    ...
    0,
    0,
    "Woodsmen live among the mighty forests of the Empire, looking after trees they will fell for timber. The more fortunate Woodsmen work for Noble families on large estates. The braver souls work on the edges of civilisation, helping to expand the settled lands. These Woodsmen must deal with all the dangers of the forest, from pitfalls and bandits to wild animals and Beastmen. They always keep their axes handy and not just for chopping wood. Woodsmen have been known to clash with Elves, since the Elves do not take kindly to the clearing of their precious forests.",
    "Concealment;Follow Trail or Set Trap;Perception;Scale Sheer Surface;Secret Language (Ranger Tongue);Secret Signs (Ranger);Silent Move",
    "Fleet Footed or Very Resilient;Rover;Specialist Weapon Gorup (Two-handed)",
    "Great Weapon (Two-handed);Light Armour (Leather Jack);Antitoxin Kit",
    "Charcoal-Burner;Vagabond",
    "Hunter;Militiaman;Outlaw;Scout;Vagabond",
    "",
    "WHFR",
    7,
  ...
  [
    ...
    "Common Knowledge (The Empire or Kislev);Consume Alcohol or Dodge Blow;Gamble or Navigation;Outdoor Survival or Sail;Perception or Search;Row;Secret Signs (Ranger) or Speak Language (Kislevite);Swim",
    "Orientation or Rover;Sharpshooter or Strike to Stun",
    "Bow with 10 Arrows;Light Armour (Leather Jack);Row Boat",
    "Boatman;Ferryman;Marine;Outlaw;Peasant;Riverwarden;Seaman;Smuggler",
    "Boatman;Marine;Outlaw;Tief;Veteran",
    "",
    "WC",
    8,
    2,
  ...
  [
    ...
    "Animal Care;Common Knowledge (Bretonnia);Concealment;Consume Alcohol;Dodge Blow;Gamble;Gossip;Intimidate;Outdoor Survival;Perception;Ride;Secret Language (Battle Tongue);Silent Move",
    ...
    "Carcassonne Shepherd;Man-at-Arms;Mercenary",
    "Faceless;Mercenary;Outlaw Chief;Scout;Sergeant",
    "Women can only become Yeomen if disguised as men.",
    "WHFR",
    13,
    5,
    24,
  ...
  [
    ...
    "Flail or Morning Star;Light Armour (Leather Jack);Bottle of Good Craftsmenship Spirit",
    "Agitator;Initiate;Judicial Champion;Peasant;Tradesmand",
