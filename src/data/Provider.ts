...
export class ProfessionProvider {
	...
	private static castToIProfession(obj: Adaptable): IProfession {
		...
		const getEnums = (str: string) => str.split(';').map(el => Professions[this.enumifyName(el) as any] as unknown as number)
		return {
			id: obj.id,
			...
			advanceFrom: getEnums(obj.EntriesClean),
			advanceTo: getEnums(obj.ExitsClean),
		}
	}
	private static createMainProfile(obj: Adaptable): IMainProfile {
		return {
			WS: this.createIStat<number>(LangData.WS, LangData.WS_DESCRIPTION, obj.WS as unknown as number),
			BS: this.createIStat<number>(LangData.BS, LangData.BS_DESCRIPTION, obj.WS as unknown as number),
			S: this.createIStat<number>(LangData.S, LangData.S_DESCRIPTION, obj.WS as unknown as number),
			T: this.createIStat<number>(LangData.T, LangData.T_DESCRIPTION, obj.WS as unknown as number),
			Ag: this.createIStat<number>(LangData.AG, LangData.AG_DESCRIPTION, obj.WS as unknown as number),
			Int: this.createIStat<number>(LangData.INT, LangData.INT_DESCRIPTION, obj.WS as unknown as number),
			WP: this.createIStat<number>(LangData.WP, LangData.WP_DESCRIPTION, obj.WS as unknown as number),
			Fel: this.createIStat<number>(LangData.FEL, LangData.FEL_DESCRIPTION, obj.WS as unknown as number),
		};
	}
	private static createSecondaryProfile(obj: Adaptable): ISecondaryProfile {
		return {
			A: this.createIStat<number>(LangData.A, LangData.A_DESCRIPTION, obj.A as unknown as number),
			W: this.createIStat<number>(LangData.W, LangData.W_DESCRIPTION, obj.W as unknown as number),
			SB: this.createIStat<number>(LangData.SB, LangData.SB_DESCRIPTION, obj.SB as unknown as number),
			TB: this.createIStat<number>(LangData.TB, LangData.TB_DESCRIPTION, obj.TB as unknown as number),
			M: this.createIStat<number>(LangData.M, LangData.M_DESCRIPTION, obj.M as unknown as number),
			Mag: this.createIStat<number>(LangData.MAG, LangData.MAG_DESCRIPTION, obj.Mag as unknown as number),
			IP: this.createIStat<number>(LangData.IP, LangData.IP_DESCRIPTION, obj.IP as unknown as number),
			FP: this.createIStat<number>(LangData.FP, LangData.FP_DESCRIPTION, obj.FP as unknown as number),
		};
	}
	private static createIStat<T>(name: string, description: string, value: T): IStat<T> {
		return {
